# Reconnaissance — Troca de Contratos

> Snapshot do DOM da área desta testsuite, capturado em 2026-05-04T12:59:48.281Z.
> Planners DEVEM consumir este arquivo + a prosa do XML, e PULAR exploração ao vivo.

## Testcases desta testsuite (do XML)

1. **Troca de Contrato: Vigente x Expirados** (importance: crítico, 4 steps)
