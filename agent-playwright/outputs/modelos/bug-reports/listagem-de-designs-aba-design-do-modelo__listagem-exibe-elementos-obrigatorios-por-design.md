# [spec-fragil] Listagem exibe elementos obrigatórios por design
...
- **TC**: Listagem exibe elementos obrigatórios por design
- **Spec**: `projects/modelos/tests/features/listagem-de-designs-aba-design-do-modelo/tc01-colunas-obrigatorias.spec.ts`
- **Erro em**: `C:\Claude\Recertificação\twygo-agents-qa\agent-playwright\projects\modelos\pages\ContentModelEditPage.ts:185:54`
- **Status**: failed (38800ms)
...
### Attachments
- ![screenshot](../test-artifacts/projects-modelos-tests-fea-aaf1b-tos-obrigatórios-por-design-chromium/test-failed-1.png)
- [video](../test-artifacts/projects-modelos-tests-fea-aaf1b-tos-obrigatórios-por-design-chromium/video.webm)
- [error-context](../test-artifacts/projects-modelos-tests-fea-aaf1b-tos-obrigatórios-por-design-chromium/error-context.md)
- [trace](../test-artifacts/projects-modelos-tests-fea-aaf1b-tos-obrigatórios-por-design-chromium/trace.zip)
