# [spec-fragil] Defaults dos switches na criação
...
- **TC**: Defaults dos switches na criação
- **Spec**: `projects/modelos/tests/features/criacao-de-modelo-aba-identificacao/tc07-defaults-switches-criacao.spec.ts`
- **Erro em**: `—`
...
- [trace](../test-artifacts/projects-modelos-tests-fea-9e86f-lts-dos-switches-na-criação-chromium/trace.zip)
