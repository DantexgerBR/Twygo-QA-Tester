# [spec-fragil] Combinação de filtros + busca textual na listagem de designs
...
- **TC**: Combinação de filtros + busca textual na listagem de designs
- **Spec**: `projects/modelos/tests/features/listagem-de-designs-aba-design-do-modelo/tc04-combinar-filtros-busca-designs.spec.ts`
- **Erro em**: `C:\Claude\Recertificação\twygo-agents-qa\agent-playwright\projects\modelos\pages\ContentModelEditPage.ts:185:54`
- **Status**: failed (38481ms)
...
### Attachments
- ![screenshot](../test-artifacts/projects-modelos-tests-fea-1d070-tual-na-listagem-de-designs-chromium/test-failed-1.png)
- [video](../test-artifacts/projects-modelos-tests-fea-1d070-tual-na-listagem-de-designs-chromium/video.webm)
- [error-context](../test-artifacts/projects-modelos-tests-fea-1d070-tual-na-listagem-de-designs-chromium/error-context.md)
- [trace](../test-artifacts/projects-modelos-tests-fea-1d070-tual-na-listagem-de-designs-chromium/trace.zip)
