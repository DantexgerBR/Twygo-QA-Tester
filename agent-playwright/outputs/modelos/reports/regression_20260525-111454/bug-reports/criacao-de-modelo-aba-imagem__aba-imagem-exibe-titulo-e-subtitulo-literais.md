# [spec-fragil] Aba Imagem exibe título e subtítulo literais
...
- **TC**: Aba Imagem exibe título e subtítulo literais
- **Spec**: `projects/modelos/tests/features/criacao-de-modelo-aba-imagem/tc01-aba-imagem-titulo-subtitulo.spec.ts`
- **Erro em**: `C:\Claude\Recertificação\twygo-agents-qa\agent-playwright\projects\modelos\pages\ContentModelEditPage.ts:265:20`
- **Status**: failed (45990ms)
...
- **Passo-a-passo**:
  1. 1. Abrir modelo seedado na aba Imagem — ❌ **falhou aqui**
...
### Attachments
- ![screenshot](../test-artifacts/projects-modelos-tests-fea-2ff59-título-e-subtítulo-literais-chromium/test-failed-1.png)
- [video](../test-artifacts/projects-modelos-tests-fea-2ff59-título-e-subtítulo-literais-chromium/video.webm)
- [error-context](../test-artifacts/projects-modelos-tests-fea-2ff59-título-e-subtítulo-literais-chromium/error-context.md)
- [trace](../test-artifacts/projects-modelos-tests-fea-2ff59-título-e-subtítulo-literais-chromium/trace.zip)
