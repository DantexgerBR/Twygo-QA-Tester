...
- **Erro em**: `C:\Claude\Recertificação\twygo-agents-qa\agent-playwright\projects\modelos\tests\features\acoes-duplicar-e-drag-and-drop\tc01-duplicar-modelo-copia-profunda.spec.ts:30:55`
- **Status**: failed (22763ms)
...
- **Passo-a-passo**:
  1. 1. Acessar listagem de modelos — ❌ **falhou aqui**
