...
- Name: projects\modelos\tests\features\filtros-e-busca-modelos\tc05-combinar-filtros-busca-textual.spec.ts >> Filtros e Busca - Modelos >> Combinação de filtros + busca textual
- Location: projects\modelos\tests\features\filtros-e-busca-modelos\tc05-combinar-filtros-busca-textual.spec.ts:6:3
