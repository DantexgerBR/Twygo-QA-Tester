...
- Name: projects\modelos\tests\features\listagem-e-menu-de-modelos\tc06-indicador-cor-status-card.spec.ts >> Listagem e Menu de Modelos >> Indicador de cor lateral reflete status ativo/inativo no card
- Location: projects\modelos\tests\features\listagem-e-menu-de-modelos\tc06-indicador-cor-status-card.spec.ts:7:3
