...
- Name: projects\modelos\tests\features\preview-de-modelos-e-designs\tc01-abrir-preview-modelo-via-card.spec.ts >> Preview de Modelos e Designs >> Abrir Preview de Modelo via card
- Location: projects\modelos\tests\features\preview-de-modelos-e-designs\tc01-abrir-preview-modelo-via-card.spec.ts:6:3
