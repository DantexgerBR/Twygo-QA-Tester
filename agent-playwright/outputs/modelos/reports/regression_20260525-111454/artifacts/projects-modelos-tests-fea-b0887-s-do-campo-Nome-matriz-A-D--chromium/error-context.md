...
- Name: projects\modelos\tests\features\criacao-de-modelo-aba-identificacao\tc04-validar-nome-obrigatorio.spec.ts >> Criação de Modelo - Aba Identificação >> Validações negativas do campo Nome (matriz A-D)
- Location: projects\modelos\tests\features\criacao-de-modelo-aba-identificacao\tc04-validar-nome-obrigatorio.spec.ts:18:3
