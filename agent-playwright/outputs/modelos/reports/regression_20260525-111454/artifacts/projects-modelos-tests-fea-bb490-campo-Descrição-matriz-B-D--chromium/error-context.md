...
- Name: projects\modelos\tests\features\criacao-de-modelo-aba-identificacao\tc05-limite-500-chars-descricao.spec.ts >> Criação de Modelo - Aba Identificação >> Validações negativas do campo Descrição (matriz B-D)
- Location: projects\modelos\tests\features\criacao-de-modelo-aba-identificacao\tc05-limite-500-chars-descricao.spec.ts:6:3
