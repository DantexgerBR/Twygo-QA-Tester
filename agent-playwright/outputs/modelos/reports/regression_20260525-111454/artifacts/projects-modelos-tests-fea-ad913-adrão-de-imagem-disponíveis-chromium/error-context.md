...
- Name: projects\modelos\tests\features\criacao-de-modelo-aba-imagem\tc02-opcoes-padrao-imagem.spec.ts >> Criação de Modelo - Aba Imagem >> Opções de padrão de imagem disponíveis
- Location: projects\modelos\tests\features\criacao-de-modelo-aba-imagem\tc02-opcoes-padrao-imagem.spec.ts:6:3
