...
- Name: projects\modelos\tests\features\criacao-de-modelo-aba-identificacao\tc02-badge-dica-aparece-na-criacao.spec.ts >> Criação de Modelo - Aba Identificação >> Badge "Dica" aparece somente na criação
- Location: projects\modelos\tests\features\criacao-de-modelo-aba-identificacao\tc02-badge-dica-aparece-na-criacao.spec.ts:6:3
