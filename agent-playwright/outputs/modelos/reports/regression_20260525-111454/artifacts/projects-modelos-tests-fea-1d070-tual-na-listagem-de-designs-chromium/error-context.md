...
- Name: projects\modelos\tests\features\listagem-de-designs-aba-design-do-modelo\tc04-combinar-filtros-busca-designs.spec.ts >> Listagem de Designs (aba Design do Modelo) >> Combinação de filtros + busca textual na listagem de designs
- Location: projects\modelos\tests\features\listagem-de-designs-aba-design-do-modelo\tc04-combinar-filtros-busca-designs.spec.ts:6:3
