...
- Name: projects\modelos\tests\features\listagem-de-designs-aba-design-do-modelo\tc03-filtrar-designs-por-tipo.spec.ts >> Listagem de Designs (aba Design do Modelo) >> Filtrar designs por Tipo (Aula/Página)
- Location: projects\modelos\tests\features\listagem-de-designs-aba-design-do-modelo\tc03-filtrar-designs-por-tipo.spec.ts:6:3
