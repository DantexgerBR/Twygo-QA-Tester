...
- Name: projects\modelos\tests\features\listagem-de-designs-aba-design-do-modelo\tc02-acoes-listagem.spec.ts >> Listagem de Designs (aba Design do Modelo) >> Ações da listagem de designs
- Location: projects\modelos\tests\features\listagem-de-designs-aba-design-do-modelo\tc02-acoes-listagem.spec.ts:6:3
