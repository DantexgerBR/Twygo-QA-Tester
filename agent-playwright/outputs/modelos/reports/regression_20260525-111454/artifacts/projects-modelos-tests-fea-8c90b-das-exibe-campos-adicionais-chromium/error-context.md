...
- Name: projects\modelos\tests\features\criacao-de-modelo-aba-estrutura-do-conteudo\tc07-switch-configuracoes-avancadas.spec.ts >> Criação de Modelo - Aba Estrutura do Conteúdo >> Switch "Configurações avançadas" exibe campos adicionais
- Location: projects\modelos\tests\features\criacao-de-modelo-aba-estrutura-do-conteudo\tc07-switch-configuracoes-avancadas.spec.ts:6:3
