...
- Name: projects\modelos\tests\features\criacao-de-modelo-aba-estilo-do-conteudo\tc01-adicionar-mais-dados-menu-6-opcoes.spec.ts >> Criação de Modelo - Aba Estilo do Conteúdo >> Botão "Adicionar mais dados" exibe menu com 6 opções
- Location: projects\modelos\tests\features\criacao-de-modelo-aba-estilo-do-conteudo\tc01-adicionar-mais-dados-menu-6-opcoes.spec.ts:6:3
