...
**Projeto:** Modelos de conteúdo · **Ambiente:** `staging-base-de-conhecimento` · **Browsers:** chromium · **Gerado em:** 20/05/2026, 14:36:01

> **Escopo:** Apenas testsuite contendo "Criação de Modelo - Aba Identificação"

> ✅ **Nenhuma falha registrada** — todos os 8 caso(s) executado(s) foram aprovados.
...
|---|---:|---|---:|---:|---:|---|---:|
| **Criação de Modelo - Aba Identificação** | 8 | `[██████████████████⊘⊘]` 7/0/1 | 88% | 0 | 1 | — | 111.2s |
