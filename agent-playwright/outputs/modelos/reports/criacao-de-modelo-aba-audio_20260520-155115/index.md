...
**Projeto:** Modelos de conteúdo · **Ambiente:** `staging-base-de-conhecimento` · **Browsers:** chromium · **Gerado em:** 20/05/2026, 15:51:15

> **Escopo:** Apenas testsuite contendo "Criação de Modelo - Aba Áudio"

> ✅ **Nenhuma falha registrada** — todos os 4 caso(s) executado(s) foram aprovados.
...
|---|---:|---|---:|---:|---:|---|---:|
| **Criação de Modelo - Aba Áudio** | 4 | `[████████████████████]` 4/0/0 | 100% | 0 | 0 | — | 88.7s |
