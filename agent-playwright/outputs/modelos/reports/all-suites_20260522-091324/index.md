...
**Projeto:** Modelos de conteúdo · **Ambiente:** `staging-base-de-conhecimento` · **Browsers:** chromium · **Gerado em:** 22/05/2026, 09:13:25
...
**Distribuição**: **6** inconclusivo · **1** spec-fragil
...
| [Drag and drop reorder designs](bug-reports/acoes-duplicar-e-drag-and-drop__drag-and-drop-reorder-designs.md) | 🧪 spec-fragil | media | baixa | Timeout sem HTTP error — possível wait/seletor frágil. Confirmar via chrome-mcp |
| [TC2 · Salvar Aula com dados válidos](bug-reports/criacao-de-design-de-aula__salvar-aula-com-dados-validos.md) | ❓ inconclusivo | baixa | media | Sem sinal Network in-scope ou padrão de erro conhecido — revisar trace |
| [TC7 · Salvar Página retorna para aba Design do Modelo](bug-reports/criacao-de-design-de-pagina__salvar-pagina-retorna-para-aba-design-do-modelo.md) | ❓ inconclusivo | baixa | media | Sem sinal Network in-scope ou padrão de erro conhecido — revisar trace |
