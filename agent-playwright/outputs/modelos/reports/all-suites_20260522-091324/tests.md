...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-3d814-em-via-submenu-Aprendizagem-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-3d814-em-via-submenu-Aprendizagem-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-ed4ce-isualização-padrão-em-Cards-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-ed4ce-isualização-padrão-em-Cards-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-36c4f--visualização-Cards-e-Lista-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-36c4f--visualização-Cards-e-Lista-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-9f639-oltip-completo-visão-Lista--chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-9f639-oltip-completo-visão-Lista--chromium/trace.zip
  ```
...
**Comportamento atual:** O elemento esperado não apareceu na tela (locator: locator('[role="tooltip"]')).
...
| Outros | runId: all-suites_20260522-091324 |
| Outros | Duração até a falha: 22.95s |
| Outros | Step impactado: 3. 3. Hover na célula e validar tooltip com texto completo |
...
Comportamento atual
O elemento esperado não apareceu na tela (locator: locator('[role="tooltip"]')).
...
- Outros:
  - Browser: chromium
  - runId: all-suites_20260522-091324
  - Duração até a falha: 22.95s
  - Step impactado: 3. 3. Hover na célula e validar tooltip com texto completo
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-81907-ar-redireciona-para-criação-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-81907-ar-redireciona-para-criação-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-83c1a-tatus-ativo-inativo-no-card-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-83c1a-tatus-ativo-inativo-no-card-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-58924-elos-Buscar-modelo-por-nome-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-58924-elos-Buscar-modelo-por-nome-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-40575-los-por-Situação-via-drawer-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-40575-los-por-Situação-via-drawer-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-5260f-tro-padrão-Modelos-próprios-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-5260f-tro-padrão-Modelos-próprios-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-7b8fa-os-Limpar-filtros-aplicados-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-7b8fa-os-Limpar-filtros-aplicados-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-bd73d-ar-modelo-com-dados-válidos-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-bd73d-ar-modelo-com-dados-válidos-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-29bba--aparece-somente-na-criação-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-29bba--aparece-somente-na-criação-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-218f9--Dica-NÃO-aparece-na-edição-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-218f9--Dica-NÃO-aparece-na-edição-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-1e774-idar-campo-Nome-obrigatório-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-1e774-idar-campo-Nome-obrigatório-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-77046-500-caracteres-da-Descrição-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-77046-500-caracteres-da-Descrição-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-383a1--exibido-somente-na-criação-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-383a1--exibido-somente-na-criação-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-9e86f-lts-dos-switches-na-criação-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-9e86f-lts-dos-switches-na-criação-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-eff58-dos-exibe-menu-com-6-opções-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-eff58-dos-exibe-menu-com-6-opções-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-d9836-cionar-campo-Idade-via-menu-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-d9836-cionar-campo-Idade-via-menu-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-436b3-de-estrutura-exibe-2-opções-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-436b3-de-estrutura-exibe-2-opções-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-5ae19-ooltip-do-Tipo-de-estrutura-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-5ae19-ooltip-do-Tipo-de-estrutura-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-10eb6-po-de-atividades-por-módulo-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-10eb6-po-de-atividades-por-módulo-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-26232-gatória-bloqueia-salvamento-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-26232-gatória-bloqueia-salvamento-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-62b2e-ria-exibe-5-opções-literais-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-62b2e-ria-exibe-5-opções-literais-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-ca9a9-exibe-configurações-básicas-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-ca9a9-exibe-configurações-básicas-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-8c90b-das-exibe-campos-adicionais-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-8c90b-das-exibe-campos-adicionais-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-27d82-Switch-Incluir-prova-final--chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-27d82-Switch-Incluir-prova-final--chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-2ff59-título-e-subtítulo-literais-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-2ff59-título-e-subtítulo-literais-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-ad913-adrão-de-imagem-disponíveis-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-ad913-adrão-de-imagem-disponíveis-chromium/trace.zip
  ```
...
| 2 | Aguardar a seleção default ser renderizada | Opção "Sem imagens, somente textos" é exibida como selecionada por padrão. | ❌ | Error: expect(received).toBe(expected) // Object.is equality | 0.10s |
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-fb2c4-Sem-imagens-somente-textos--chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-fb2c4-Sem-imagens-somente-textos--chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-d8ce1-título-e-subtítulo-literais-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-d8ce1-título-e-subtítulo-literais-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-36075-o-Opções-de-voz-disponíveis-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-36075-o-Opções-de-voz-disponíveis-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-a5dd1--Aba-Áudio-Default-voz-Ana--chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-a5dd1--Aba-Áudio-Default-voz-Ana--chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-10e36-de-preview-de-voz-funcional-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-10e36-de-preview-de-voz-funcional-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-20009-e-Página-via-menu-Adicionar-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-20009-e-Página-via-menu-Adicionar-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-49207-tórios-da-aba-Identificação-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-49207-tórios-da-aba-Identificação-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-8db40-to-ao-selecionar-tipo-Capa--chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-8db40-to-ao-selecionar-tipo-Capa--chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-8d1bd-ágina-Tooltip-do-campo-Tipo-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-8d1bd-ágina-Tooltip-do-campo-Tipo-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-a430e-redireciona-para-aba-Design-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-a430e-redireciona-para-aba-Design-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-4e05e-ate-Editor-com-Kit-de-Marca-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-4e05e-ate-Editor-com-Kit-de-Marca-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-7970b-a-para-aba-Design-do-Modelo-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-7970b-a-para-aba-Design-do-Modelo-chromium/trace.zip
  ```
...
**Comportamento atual:** O elemento esperado não apareceu na tela (locator: getByText('Design TC7 w4-1779451715441', { exact: true }).first()).
...
| Outros | Step impactado: 3. 3. Validar listagem atualizada com o novo Design |
...
Comportamento atual
O elemento esperado não apareceu na tela (locator: getByText('Design TC7 w4-1779451715441', { exact: true }).first()).
...
- Outros:
  ...
  - Step impactado: 3. 3. Validar listagem atualizada com o novo Design
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-56d34--de-Aula-via-menu-Adicionar-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-56d34--de-Aula-via-menu-Adicionar-chromium/trace.zip
  ```
...
> _Step impactado:_ **5. Salvar e validar redirect pra aba Design da Aula**
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-f0989-lvar-Aula-com-dados-válidos-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-f0989-lvar-Aula-com-dados-válidos-chromium/trace.zip
  ```
...
**Comportamento atual:** A URL não bateu com a esperada (esperada: not /template_designs\/new/) — atual: "https://basedeconhecimento.stage.twygoead.com/o/37007/content_models/7/template_designs/new?kind=lesson".
...
Comportamento atual
A URL não bateu com a esperada (esperada: not /template_designs\/new/) — atual: "https://basedeconhecimento.stage.twygoead.com/o/37007/content_models/7/template_designs/new?kind=lesson".
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-aaf1b-tos-obrigatórios-por-design-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-aaf1b-tos-obrigatórios-por-design-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-d7a33-ções-da-listagem-de-designs-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-d7a33-ções-da-listagem-de-designs-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-0ec35-signs-por-Tipo-Aula-Página--chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-0ec35-signs-por-Tipo-Aula-Página--chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-81805-r-modelo-com-cópia-profunda-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-81805-r-modelo-com-cópia-profunda-chromium/trace.zip
  ```
...
**Comportamento atual:** O elemento esperado não apareceu na tela (locator: getByRole('heading', { name: 'Modelos de conteúdo' })).
...
| Outros | Step impactado: 1. 1. Acessar listagem de modelos |
...
Comportamento atual
O elemento esperado não apareceu na tela (locator: getByRole('heading', { name: 'Modelos de conteúdo' })).
...
- Outros:
  ...
  - Step impactado: 1. 1. Acessar listagem de modelos
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-58f7a--Duplicar-design-individual-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-58f7a--Duplicar-design-individual-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-39e1a-ag-and-drop-reorder-designs-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-39e1a-ag-and-drop-reorder-designs-chromium/trace.zip
  ```
...
**Comportamento atual:** TimeoutError: locator.dragTo: Timeout 30000ms exceeded.
...
| Outros | Step impactado: 2. 2. Arrastar 2º design pra primeira posição via drag handle |
...
- Outros:
  ...
  - Step impactado: 2. 2. Arrastar 2º design pra primeira posição via drag handle
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-0eadb-ilitado-quando-filtro-ativo-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-0eadb-ilitado-quando-filtro-ativo-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-b2a65--Preview-de-Modelo-via-card-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-b2a65--Preview-de-Modelo-via-card-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-4071c-o-de-cada-item-do-carrossel-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-4071c-o-de-cada-item-do-carrossel-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-dda88-r-entre-slides-no-carrossel-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-dda88-r-entre-slides-no-carrossel-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-57886--Página-tem-zoom-com-scroll-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-57886--Página-tem-zoom-com-scroll-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-c7334-ão-de-cor-em-uso-por-modelo-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-c7334-ão-de-cor-em-uso-por-modelo-chromium/trace.zip
  ```
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-modelos-tests-fea-4775d--cor-sem-modelos-associados-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/modelos/reports/all-suites_20260522-091324/artifacts/projects-modelos-tests-fea-4775d--cor-sem-modelos-associados-chromium/trace.zip
  ```
