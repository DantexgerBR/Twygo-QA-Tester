...
**Projeto:** Modelos de conteúdo · **Ambiente:** `staging-base-de-conhecimento` · **Browsers:** chromium · **Gerado em:** 20/05/2026, 16:38:14

> **Escopo:** Apenas testsuite contendo "Criação de Design de Aula"
...
|---|---:|---|---:|---:|---:|---|---:|
| **Criação de Design de Aula** | 4 | `[██████████⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘]` 2/0/2 | 50% | 0 | 2 | — | 47.9s |
