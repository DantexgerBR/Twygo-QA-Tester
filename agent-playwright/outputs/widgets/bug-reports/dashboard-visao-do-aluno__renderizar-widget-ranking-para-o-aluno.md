# [inconclusivo] Renderizar widget 'Ranking' para o aluno
...
- **TC**: Renderizar widget 'Ranking' para o aluno
- **Spec**: `projects/widgets/tests/features/dashboard-visao-do-aluno/renderizar-widget-ranking.spec.ts`
- **Erro em**: `D:\twygo-agents-qa\agent-playwright\src\pages\ProfileSwitcher.ts:74:34`
- **Status**: failed (26357ms)
...
### Attachments
- ![screenshot](../test-artifacts/projects-widgets-tests-fea-6506e-widget-Ranking-para-o-aluno-chromium/test-failed-1.png)
- [video](../test-artifacts/projects-widgets-tests-fea-6506e-widget-Ranking-para-o-aluno-chromium/video-1.webm)
- [video](../test-artifacts/projects-widgets-tests-fea-6506e-widget-Ranking-para-o-aluno-chromium/video.webm)
- [error-context](../test-artifacts/projects-widgets-tests-fea-6506e-widget-Ranking-para-o-aluno-chromium/error-context.md)
- [trace](../test-artifacts/projects-widgets-tests-fea-6506e-widget-Ranking-para-o-aluno-chromium/trace.zip)
