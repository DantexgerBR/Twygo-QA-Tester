...
- `https://widgets.stage.twygoead.com/o/36988/use_modes/70077/edit?tab=items`
  59/135 interativos visíveis (**44%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu

<details><summary>📁 Fora do escopo "Widgets" — 17 erro(s) · 12 aviso(s) · 1 info _(silenciado dos KPIs principais)_</summary>
