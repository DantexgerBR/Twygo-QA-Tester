...
#### ℹ️ Cobertura observada por URL (10)

- `https://widgets.stage.twygoead.com/o/36988/panels/803495/edit?tab=layouts`
  57/134 interativos visíveis (**43%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu
- `https://widgets.stage.twygoead.com/o/36988/panels/803497/edit?tab=layouts`
...
- `https://widgets.stage.twygoead.com/o/36988/panels/803499/edit?tab=layouts`
...
- `https://widgets.stage.twygoead.com/o/36988/panels/803500/edit?tab=layouts`
...
- `https://widgets.stage.twygoead.com/o/36988/panels/new`
  62/177 interativos visíveis (**35%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu
- `https://widgets.stage.twygoead.com/o/36988/panels/803501/edit?tab=layouts`
  53/130 interativos visíveis (**41%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu
- `https://widgets.stage.twygoead.com/o/36988/panels/803502/edit?tab=layouts`
  53/130 interativos visíveis (**41%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu
- `https://widgets.stage.twygoead.com/o/36988/panels/803498/edit?tab=layouts`
...
- `https://widgets.stage.twygoead.com/o/36988/panels/803503/edit?tab=layouts`
  54/131 interativos visíveis (**41%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu
- `https://widgets.stage.twygoead.com/o/36988/panels/803504/edit?tab=layouts`
  54/131 interativos visíveis (**41%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu

<details><summary>📁 Fora do escopo "Widgets" — 219 erro(s) · 48 aviso(s) _(silenciado dos KPIs principais)_</summary>

#### ❌ Erros JavaScript no navegador (117 ocorrência(s) · 6 mensagem(ens) distinta(s))

- **Erro JavaScript no navegador** — _48 ocorrência(s) em 18 URL(s)_
  > Failed to load resource: the server responded with a status of 500 ()
- **Erro JavaScript no navegador** — _33 ocorrência(s) em 15 URL(s)_
  > Socket error: ServerError: Internal server error.
- **Erro JavaScript no navegador** — _32 ocorrência(s) em 21 URL(s)_
  > Failed to load resource: net::ERR_BLOCKED_BY_CLIENT.Inspector
- **Erro JavaScript no navegador** — _2 ocorrência(s) em 1 URL(s)_
  > Failed to load resource: net::ERR_CONNECTION_CLOSED
  `https://widgets.stage.twygoead.com/o/36988/panels/803497/edit`
...
#### ❌ Respostas HTTP de falha (48 no total · 1 únicas)

| Status | Método | URL | Ocorrências |
|---:|---|---|---:|
| 500 | GET | `https://chat-staging.twygo.com.br/v1/notificates/all?page=1&per_page=25` | 48 |

#### ❌ Acessibilidade — axe-core (102 no total · 14 regra(s) única(s))
...
- **`region`** _(moderate)_ — 10 ocorrência(s) em 10 URL(s)
  ...
  ```
- **`aria-allowed-attr`** _(critical)_ — 9 ocorrência(s) em 9 URL(s)
  ...
  ```
- **`image-alt`** _(critical)_ — 9 ocorrência(s) em 9 URL(s)
...
- **`label`** _(critical)_ — 9 ocorrência(s) em 9 URL(s)
  ...
  ```
- **`landmark-one-main`** _(moderate)_ — 9 ocorrência(s) em 9 URL(s)
  ...
  ```
- **`list`** _(serious)_ — 9 ocorrência(s) em 9 URL(s)
  ...
  <ul class="menu-main">
  ```
- **`page-has-heading-one`** _(moderate)_ — 9 ocorrência(s) em 9 URL(s)
...
- `https://widgets.stage.twygoead.com/o/36988/use_modes?tab=panels-tab`
  80/158 interativos visíveis (**51%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu

<details><summary>📁 Fora do escopo "Widgets" — 59 erro(s) · 31 aviso(s) · 10 info _(silenciado dos KPIs principais)_</summary>
...
| Status | Método | URL | Ocorrências |
|---:|---|---|---:|
| 422 | PATCH | `https://widgets.stage.twygoead.com/api/v1/o/36988/panels/803176/change_status` | 1 |

#### ❌ Acessibilidade — axe-core (98 no total · 10 regra(s) única(s))

- **`aria-allowed-attr`** _(critical)_ — 10 ocorrência(s) em 1 URL(s)
  [a11y/aria-allowed-attr] Elements must only use supported ARIA attributes · _WCAG: cat.aria, wcag2a, wcag412, EN-301-549, EN-9.4.1.2, RGAAv4, RGAA-7.1.1_
  [Como corrigir →](https://dequeuniversity.com/rules/axe/4.11/aria-allowed-attr?application=playwright)
  Seletor: `#popover-trigger-\:r5\:`
  ```html
  <div id="popover-trigger-:r5:" aria-haspopup="dialog" aria-expanded="false" aria-controls="popover-content-:r5:" class="css-tz0gqg">
  ```
- **`color-contrast`** _(serious)_ — 10 ocorrência(s) em 1 URL(s)
  [a11y/color-contrast] Elements must meet minimum color contrast ratio thresholds · _WCAG: cat.color, wcag2aa, wcag143, TTv5, TT13.c, EN-301-549, EN-9.1.4.3, ACT, RGAAv4, RGAA-3.2.1_
  [Como corrigir →](https://dequeuniversity.com/rules/axe/4.11/color-contrast?application=playwright)
  Seletor: `.top-user-name__infor > .name`
  ```html
  ...
  ```
- **`empty-table-header`** _(minor)_ — 10 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`image-alt`** _(critical)_ — 10 ocorrência(s) em 1 URL(s)
  [a11y/image-alt] Images must have alternative text · _WCAG: cat.text-alternatives, wcag2a, wcag111, section508, section508.22.a, TTv5, TT7.a, TT7.b, EN-301-549, EN-9.1.1.1, ACT, RGAAv4, RGAA-1.1.1_
  [Como corrigir →](https://dequeuniversity.com/rules/axe/4.11/image-alt?application=playwright)
  Seletor: `#mobile-close-menu > img`
  ```html
  <img src="/assets/svg/mobile-close-menu.svg">
  ```
- **`landmark-unique`** _(moderate)_ — 10 ocorrência(s) em 1 URL(s)
  [a11y/landmark-unique] Landmarks should have a unique role or role/label/title (i.e. accessible name) combination · _WCAG: cat.semantics, best-practice_
  [Como corrigir →](https://dequeuniversity.com/rules/axe/4.11/landmark-unique?application=playwright)
  ...
  <div role="region" aria-live="polite" aria-label="Notifications-top" id="chakra-toast-manager..." style="position: fixed; z-i...">
  ```
- **`list`** _(serious)_ — 10 ocorrência(s) em 1 URL(s)
  [a11y/list] <ul> and <ol> must only directly contain <li>, <script> or <template> elements · _WCAG: cat.structure, wcag2a, wcag131, EN-301-549, EN-9.1.3.1, RGAAv4, RGAA-9.3.1_
  [Como corrigir →](https://dequeuniversity.com/rules/axe/4.11/list?application=playwright)
  Seletor: `.mobile-user-menu > .menu-main`
  ```html
  <ul class="menu-main">
  ```
- **`meta-viewport`** _(moderate)_ — 10 ocorrência(s) em 1 URL(s)
  [a11y/meta-viewport] Zooming and scaling must not be disabled · _WCAG: cat.sensory-and-visual-cues, wcag2aa, wcag144, EN-301-549, EN-9.1.4.4, ACT, RGAAv4, RGAA-10.4.2_
  [Como corrigir →](https://dequeuniversity.com/rules/axe/4.11/meta-viewport?application=playwright)
  Seletor: `meta[name="viewport"]`
  ```html
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no, minimal-ui" name="viewport">
  ```
- **`region`** _(moderate)_ — 10 ocorrência(s) em 1 URL(s)
  [a11y/region] All page content should be contained by landmarks · _WCAG: cat.keyboard, best-practice, RGAAv4, RGAA-9.2.1_
  [Como corrigir →](https://dequeuniversity.com/rules/axe/4.11/region?application=playwright)
  Seletor: `#mobile-logo > img[alt="Logo - widgets [36988]"][title="Logo - widgets [36988]"]`
  ```html
  <img title="Logo - widgets [36988]" alt="Logo - widgets [36988]" style="height: 50px; align: center" src="https://cdn-stage.twygo.com/uploads/organizations_36988_medium_logo_1778081380.png?1778081380"
  ```
- **`label`** _(critical)_ — 9 ocorrência(s) em 1 URL(s)
  [a11y/label] Form elements must have labels · _WCAG: cat.forms, wcag2a, wcag412, section508, section508.22.n, TTv5, TT5.c, EN-301-549, EN-9.4.1.2, ACT, RGAAv4, RGAA-11.1.1_
  [Como corrigir →](https://dequeuniversity.com/rules/axe/4.11/label?application=playwright)
  Seletor: `#panel-situation-803176`
  ```html
  <input class="chakra-switch__input" type="checkbox" id="panel-situation-803176" value="" checked="" style="border: 0px; clip: rect(0px, 0px, 0px, 0px); height: 1px; width: 1px; margin: -1px; padding: 
  ```
- **`select-name`** _(critical)_ — 9 ocorrência(s) em 1 URL(s)
