...
<details><summary>📁 Fora do escopo "Widgets" — 31 erro(s) · 14 aviso(s) · 4 info _(silenciado dos KPIs principais)_</summary>
...
|---:|---|---|---:|
| 500 | GET | `https://widgets.stage.twygoead.com/api/v1/o/36988/panels/802642/linked_menus` | 1 |
| 500 | GET | `https://widgets.stage.twygoead.com/api/v1/o/36988/panels/802643/linked_menus` | 1 |
...
- **`label`** _(critical)_ — 4 ocorrência(s) em 1 URL(s)
  ...
  Seletor: `#panel-situation-802644`
  ```html
  <input class="chakra-switch__input" type="checkbox" id="panel-situation-802644" value="" checked="" style="border: 0px; clip: rect(0px, 0px, 0px, 0px); height: 1px; width: 1px; margin: -1px; padding: 
  ```
