...
- `https://widgets.stage.twygoead.com/o/36988/use_modes?tab=panels-tab`
  81/157 interativos visíveis (**52%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu

<details><summary>📁 Fora do escopo "Widgets" — 33 erro(s) · 16 aviso(s) · 5 info _(silenciado dos KPIs principais)_</summary>

#### ❌ Erros JavaScript no navegador (2 ocorrência(s) · 2 mensagem(ens) distinta(s))

- **Erro JavaScript no navegador** — _1 ocorrência(s) em 1 URL(s)_
  > Failed to load resource: the server responded with a status of 500 ()
  `https://widgets.stage.twygoead.com/o/36988/panels/802974/edit`
- **Erro JavaScript no navegador** — _1 ocorrência(s) em 1 URL(s)_
  > Failed to load resource: the server responded with a status of 422 ()
  `https://widgets.stage.twygoead.com/o/36988/use_modes?tab=panels-tab`

#### ❌ Respostas HTTP de falha (2 no total · 2 únicas)

| Status | Método | URL | Ocorrências |
|---:|---|---|---:|
| 500 | GET | `https://widgets.stage.twygoead.com/api/v1/o/36988/panels/802974/linked_menus` | 1 |
| 422 | PATCH | `https://widgets.stage.twygoead.com/api/v1/o/36988/panels/802981/change_status` | 1 |

#### ❌ Acessibilidade — axe-core (50 no total · 10 regra(s) única(s))

- **`aria-allowed-attr`** _(critical)_ — 5 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`color-contrast`** _(serious)_ — 5 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`empty-table-header`** _(minor)_ — 5 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`image-alt`** _(critical)_ — 5 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`label`** _(critical)_ — 5 ocorrência(s) em 1 URL(s)
  ...
  Seletor: `#panel-situation-802977`
  ```html
  <input class="chakra-switch__input" type="checkbox" id="panel-situation-802977" value="" style="border: 0px; clip: rect(0px, 0px, 0px, 0px); height: 1px; width: 1px; margin: -1px; padding: 0px; overfl
  ```
- **`landmark-unique`** _(moderate)_ — 5 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`list`** _(serious)_ — 5 ocorrência(s) em 1 URL(s)
  ...
  <ul class="menu-main">
  ```
- **`meta-viewport`** _(moderate)_ — 5 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`region`** _(moderate)_ — 5 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`select-name`** _(critical)_ — 5 ocorrência(s) em 1 URL(s)
