...
- `https://widgets.stage.twygoead.com/o/36988/use_modes?tab=panels-tab`
  80/155 interativos visíveis (**52%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu

<details><summary>📁 Fora do escopo "Widgets" — 30 erro(s) · 12 aviso(s) · 4 info _(silenciado dos KPIs principais)_</summary>
...
#### ❌ Respostas HTTP de falha (3 no total · 3 únicas)

| Status | Método | URL | Ocorrências |
|---:|---|---|---:|
| 500 | GET | `https://widgets.stage.twygoead.com/api/v1/o/36988/panels/802967/linked_menus` | 1 |
| 500 | GET | `https://widgets.stage.twygoead.com/api/v1/o/36988/panels/802966/linked_menus` | 1 |
| 500 | GET | `https://widgets.stage.twygoead.com/api/v1/o/36988/panels/802969/linked_menus` | 1 |

#### ❌ Acessibilidade — axe-core (40 no total · 10 regra(s) única(s))
...
- **`aria-allowed-attr`** _(critical)_ — 4 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`color-contrast`** _(serious)_ — 4 ocorrência(s) em 1 URL(s)
...
- **`image-alt`** _(critical)_ — 4 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`label`** _(critical)_ — 4 ocorrência(s) em 1 URL(s)
  ...
  Seletor: `#panel-situation-802968`
  ```html
  <input class="chakra-switch__input" type="checkbox" id="panel-situation-802968" value="" checked="" style="border: 0px; clip: rect(0px, 0px, 0px, 0px); height: 1px; width: 1px; margin: -1px; padding: 
  ```
- **`landmark-unique`** _(moderate)_ — 4 ocorrência(s) em 1 URL(s)
...
- **`list`** _(serious)_ — 4 ocorrência(s) em 1 URL(s)
  ...
  <ul class="menu-main">
  ```
- **`meta-viewport`** _(moderate)_ — 4 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`region`** _(moderate)_ — 4 ocorrência(s) em 1 URL(s)
