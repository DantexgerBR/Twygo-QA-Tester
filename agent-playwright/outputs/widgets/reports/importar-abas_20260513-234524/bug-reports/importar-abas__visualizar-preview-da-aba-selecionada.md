# [modal-nao-tratado] Visualizar preview da aba selecionada
...
- **Erro em**: `D:\twygo-agents-qa\agent-playwright\projects\widgets\tests\features\importar-abas\visualizar-preview-aba.spec.ts:53:46`
- **Status**: failed (45740ms)
