# [modal-nao-tratado] Selecionar Categoria na importação
...
- **Erro em**: `D:\twygo-agents-qa\agent-playwright\projects\widgets\tests\features\importar-abas\selecionar-categoria-importacao.spec.ts:51:46`
- **Status**: failed (45956ms)
