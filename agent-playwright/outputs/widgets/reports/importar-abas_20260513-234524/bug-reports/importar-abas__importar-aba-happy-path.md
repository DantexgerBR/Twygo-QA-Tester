# [modal-nao-tratado] Importar aba (happy path)
...
- **Erro em**: `D:\twygo-agents-qa\agent-playwright\projects\widgets\tests\features\importar-abas\importar-aba-happy-path.spec.ts:45:46`
- **Status**: failed (46181ms)
