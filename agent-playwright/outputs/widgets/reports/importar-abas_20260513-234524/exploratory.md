...
- `https://widgets.stage.twygoead.com/o/36988/panels/803453/edit?tab=layouts`
...
- `https://widgets.stage.twygoead.com/o/36988/panels/803451/edit?tab=layouts`
  61/138 interativos visíveis (**44%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu
- `https://widgets.stage.twygoead.com/o/36988/panels/803454/edit?tab=layouts`
...
- `https://widgets.stage.twygoead.com/o/36988/panels/803452/edit?tab=layouts`
  61/138 interativos visíveis (**44%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu
- `about:blank`
  0/0 interativos visíveis (**0%**) · amostra: _(vazio)_
- `https://widgets.stage.twygoead.com/o/36988/panels/803455/edit?tab=layouts`
  61/138 interativos visíveis (**44%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu
- `https://widgets.stage.twygoead.com/o/36988/panels/803456/edit?tab=layouts`
  61/138 interativos visíveis (**44%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu
- `https://widgets.stage.twygoead.com/o/36988/panels/803457/edit?tab=layouts`
  61/138 interativos visíveis (**44%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu
- `https://widgets.stage.twygoead.com/o/36988/panels/803458/edit?tab=layouts`
  58/135 interativos visíveis (**43%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu
- `https://widgets.stage.twygoead.com/o/36988/panels/803460/edit?tab=layouts`
  61/138 interativos visíveis (**44%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu
- `https://widgets.stage.twygoead.com/o/36988/panels/803459/edit?tab=layouts`
  58/135 interativos visíveis (**43%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu

<details><summary>📁 Fora do escopo "Widgets" — 183 erro(s) · 32 aviso(s) _(silenciado dos KPIs principais)_</summary>

#### ❌ Erros JavaScript no navegador (133 ocorrência(s) · 4 mensagem(ens) distinta(s))

- **Erro JavaScript no navegador** — _106 ocorrência(s) em 21 URL(s)_
...
- **Erro JavaScript no navegador** — _12 ocorrência(s) em 6 URL(s)_
...
#### ❌ Acessibilidade — axe-core (82 no total · 14 regra(s) única(s))
...
- **`landmark-unique`** _(moderate)_ — 10 ocorrência(s) em 10 URL(s)
  ...
  Seletor: `.chakra-portal:nth-child(33) > div[aria-label="Notifications-top"][role="region"][aria-live="polite"]`
  ```html
...
- **`label`** _(critical)_ — 9 ocorrência(s) em 9 URL(s)
  ...
  ```
- **`aria-allowed-attr`** _(critical)_ — 7 ocorrência(s) em 7 URL(s)
  ...
  ```
- **`image-alt`** _(critical)_ — 7 ocorrência(s) em 7 URL(s)
  ...
  ```
- **`list`** _(serious)_ — 7 ocorrência(s) em 7 URL(s)
  ...
  <ul class="menu-main">
  ```
- **`aria-progressbar-name`** _(serious)_ — 6 ocorrência(s) em 6 URL(s)
  ...
  ```
- **`label-title-only`** _(serious)_ — 2 ocorrência(s) em 2 URL(s)
