...
- `https://widgets.stage.twygoead.com/o/36988/panels/803479/edit?tab=layouts`
...
- `https://widgets.stage.twygoead.com/o/36988/panels/803483/edit?tab=layouts`
...
- `https://widgets.stage.twygoead.com/o/36988/panels/803478/edit?tab=layouts`
...
- `https://widgets.stage.twygoead.com/o/36988/panels/803484/edit?tab=layouts`
  62/139 interativos visíveis (**45%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu
- `about:blank`
  0/0 interativos visíveis (**0%**) · amostra: _(vazio)_
- `https://widgets.stage.twygoead.com/o/36988/panels/803485/edit?tab=layouts`
...
- `https://widgets.stage.twygoead.com/o/36988/panels/803486/edit?tab=layouts`
  62/139 interativos visíveis (**45%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu
- `https://widgets.stage.twygoead.com/o/36988/panels/803491/edit?tab=layouts`
...
- `https://widgets.stage.twygoead.com/o/36988/panels/803488/edit?tab=layouts`
  58/135 interativos visíveis (**43%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu
- `https://widgets.stage.twygoead.com/o/36988/panels/803492/edit?tab=layouts`
  62/139 interativos visíveis (**45%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu
- `https://widgets.stage.twygoead.com/o/36988/panels/803490/edit?tab=layouts`
  58/135 interativos visíveis (**43%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu

<details><summary>📁 Fora do escopo "Widgets" — 135 erro(s) · 36 aviso(s) _(silenciado dos KPIs principais)_</summary>

#### ❌ Erros JavaScript no navegador (84 ocorrência(s) · 4 mensagem(ens) distinta(s))

- **Erro JavaScript no navegador** — _48 ocorrência(s) em 33 URL(s)_
  > Failed to load resource: net::ERR_BLOCKED_BY_CLIENT.Inspector
- **Erro JavaScript no navegador** — _18 ocorrência(s) em 11 URL(s)_
  > Socket error: ServerError: Internal server error.
- **Erro JavaScript no navegador** — _16 ocorrência(s) em 10 URL(s)_
...
#### ❌ Respostas HTTP de falha (16 no total · 1 únicas)

| Status | Método | URL | Ocorrências |
|---:|---|---|---:|
| 500 | GET | `https://chat-staging.twygo.com.br/v1/notificates/all?page=1&per_page=25` | 16 |

#### ❌ Acessibilidade — axe-core (71 no total · 15 regra(s) única(s))
...
- **`label`** _(critical)_ — 9 ocorrência(s) em 9 URL(s)
  ...
  ```
- **`select-name`** _(critical)_ — 4 ocorrência(s) em 4 URL(s)
