...
|---:|---|---|---:|
| 500 | GET | `https://widgets.stage.twygoead.com/api/v1/o/36988/panels/802943/linked_menus` | 1 |
| 500 | GET | `https://widgets.stage.twygoead.com/api/v1/o/36988/panels/802946/linked_menus` | 1 |
...
- **`label`** _(critical)_ — 3 ocorrência(s) em 1 URL(s)
  ...
  Seletor: `#panel-situation-802946`
  ```html
  <input class="chakra-switch__input" type="checkbox" id="panel-situation-802946" value="" style="border: 0px; clip: rect(0px, 0px, 0px, 0px); height: 1px; width: 1px; margin: -1px; padding: 0px; overfl
  ```
