...
_11 caso(s) — 0 aprovado(s), 10 falha(s), 1 ignorado(s)_

### ❌ Falhou · TC1 · Acessar o fluxo de Importar de outro painel · 🔴 Crítico

<a id="acessar-o-fluxo-de-importar-de-outro-painel"></a>_Arquivo:_ `acessar-fluxo-importar-painel.spec.ts` · _Duração:_ 23.84s · _Browser:_ chromium

> **❌ Por que falhou:** O elemento esperado não apareceu na tela (locator: getByTestId('tabs-navigation-add-button')).
> _Step impactado:_ **1. Criar Painel Destino e abrir tab Layouts**
...
|---|---|---|:---:|---|---:|
| 1 | Acessar a aba 'Layouts' do painel em edição | Aba existente é exibida | ❌ | O elemento esperado não apareceu na tela (locator: getByTestId('tabs-navigation-add-button')). | 21.86s |
| 2 | Clicar no botão 'Adicionar aba' | Modal 'Adicionar nova aba' é exibido com subtítulo 'Escolha como deseja criar a nova aba' | ⊘ | Step não executado: o teste foi interrompido antes. Causa: O elemento esperado não apareceu na tela (locator: getByTestId('tabs-navigation-add-button')).. | — |
| 3 | Validar botão da opção 'Importar de outro painel' | Deve exibir um ícone de download<br /> Com a descrição:<br /> Reutilize uma aba existente de outro painel | ⊘ | Step não executado: o teste foi interrompido antes. Causa: O elemento esperado não apareceu na tela (locator: getByTestId('tabs-navigation-add-button')).. | — |
| 4 | Clicar na opção 'Importar de outro painel' | Avança step no modal exibindo: <br /> Título: Adicionar nova aba<br /> Subtítulo: Importar de outro painel<br /> Campo: Painel de origem | ⊘ | Step não executado: o teste foi interrompido antes. Causa: O elemento esperado não apareceu na tela (locator: getByTestId('tabs-navigation-add-button')).. | — |
| 5 | Verificar outras opções do step | Nenhuma outra opção ou preview de aba deve ser exibida enquanto painel de origem não estiver selecionado | ⊘ | Step não executado: o teste foi interrompido antes. Causa: O elemento esperado não apareceu na tela (locator: getByTestId('tabs-navigation-add-button')).. | — |
...
- 📸 **Screenshot (screenshot)** — [`test-failed-1.png`](artifacts/projects-widgets-tests-fea-cfe25-de-Importar-de-outro-painel-chromium/test-failed-1.png)

  ![](artifacts/projects-widgets-tests-fea-cfe25-de-Importar-de-outro-painel-chromium/test-failed-1.png)
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-widgets-tests-fea-cfe25-de-Importar-de-outro-painel-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/widgets/reports/importar-abas_20260513-234017/artifacts/projects-widgets-tests-fea-cfe25-de-Importar-de-outro-painel-chromium/trace.zip
  ```
...
- 📄 **DOM no momento da falha** — [`error-context.md`](artifacts/projects-widgets-tests-fea-cfe25-de-Importar-de-outro-painel-chromium/error-context.md)

#### 🐛 Pronto para registro de bug

**Descrição do BUG:** [Crítico] Acessar o fluxo de Importar de outro painel — O elemento esperado não apareceu na tela (locator: getByTestId('tabs-navigation-add-button')).

**Passo a passo para reprodução:**
1. Pré: Ambiente Stage configurado Funcionalidade 'Gestão de Painéis' habilitada no contrato Feature flag 'habilitar_paineis_do_usuario' ativa Usuário logado como Admin Painel em edição com pelo menos uma aba Existem outros painéis com abas e widgets disponíveis
1. 1. Acessar a aba 'Layouts' do painel em edição
1. 2. Clicar no botão 'Adicionar aba'
1. 3. Validar botão da opção 'Importar de outro painel'
1. 4. Clicar na opção 'Importar de outro painel'
1. 5. Verificar outras opções do step

**Comportamento esperado:** Aba existente é exibida

**Comportamento atual:** O elemento esperado não apareceu na tela (locator: getByTestId('tabs-navigation-add-button')).
...
| Outros | runId: importar-abas_20260513-234017 |
| Outros | Duração até a falha: 23.84s |
| Outros | Step impactado: 1. 1. Criar Painel Destino e abrir tab Layouts |

**Evidências:**

- Screenshot capturado pelo Playwright (screenshot): artifacts/projects-widgets-tests-fea-cfe25-de-Importar-de-outro-painel-chromium/test-failed-1.png
- Vídeo da execução (video-1.webm): artifacts/projects-widgets-tests-fea-cfe25-de-Importar-de-outro-painel-chromium/video-1.webm
- Vídeo da execução (video.webm): artifacts/projects-widgets-tests-fea-cfe25-de-Importar-de-outro-painel-chromium/video.webm
- Snapshot do DOM/contexto da página (error-context.md): artifacts/projects-widgets-tests-fea-cfe25-de-Importar-de-outro-painel-chromium/error-context.md
- Trace completo do Playwright (.zip) — `npx playwright show-trace`: artifacts/projects-widgets-tests-fea-cfe25-de-Importar-de-outro-painel-chromium/trace.zip

<details><summary>📋 Ver texto agregado para copiar (Jira/GitHub/Linear)</summary>

```
Descrição do BUG
[Crítico] Acessar o fluxo de Importar de outro painel — O elemento esperado não apareceu na tela (locator: getByTestId('tabs-navigation-add-button')).

Passo a passo para reprodução
  Pré: Ambiente Stage configurado Funcionalidade 'Gestão de Painéis' habilitada no contrato Feature flag 'habilitar_paineis_do_usuario' ativa Usuário logado como Admin Painel em edição com pelo menos uma aba Existem outros painéis com abas e widgets disponíveis
  1. Acessar a aba 'Layouts' do painel em edição
  2. Clicar no botão 'Adicionar aba'
  3. Validar botão da opção 'Importar de outro painel'
  4. Clicar na opção 'Importar de outro painel'
  5. Verificar outras opções do step

Comportamento esperado
Aba existente é exibida

Comportamento atual
O elemento esperado não apareceu na tela (locator: getByTestId('tabs-navigation-add-button')).
...
- Outros:
  - Browser: chromium
  - runId: importar-abas_20260513-234017
  - Duração até a falha: 23.84s
  - Step impactado: 1. 1. Criar Painel Destino e abrir tab Layouts
...
- testcase: Acessar o fluxo de Importar de outro painel
...
<a id="auto-preencher-nome-da-nova-aba-com-nome-original-e-validar-limite-de-255-caracteres"></a>_Arquivo:_ `auto-preencher-nome-aba-importada.spec.ts` · _Duração:_ 44.32s · _Browser:_ chromium
...
| # | Ação do passo | Resultado esperado | Status | Notas | Duração |
|---|---|---|:---:|---|---:|
| — | _Pré-condição:_ 1. Criar Painel Origem com Aba X seedada e abrir modal de importar do Painel Destino | — | ❌ | Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')). | 41.89s |
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-widgets-tests-fea-03512-ar-limite-de-255-caracteres-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/widgets/reports/importar-abas_20260513-234017/artifacts/projects-widgets-tests-fea-03512-ar-limite-de-255-caracteres-chromium/trace.zip
  ```
...
**Descrição do BUG:** [—] Auto-preencher 'Nome da nova aba' com nome original e validar limite de 255 caracteres — Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')).
...
| Outros | Browser: chromium |
| Outros | runId: importar-abas_20260513-234017 |
| Outros | Duração até a falha: 44.32s |
...
```
Descrição do BUG
[—] Auto-preencher 'Nome da nova aba' com nome original e validar limite de 255 caracteres — Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')).
...
### ❌ Falhou · TC8 · Cancelar importação · 🟡 Normal

<a id="cancelar-importacao"></a>_Arquivo:_ `cancelar-importacao.spec.ts` · _Duração:_ 44.44s · _Browser:_ chromium

> **❌ Por que falhou:** Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')).
> _Step impactado:_ **1. Criar painel, abrir Layouts e ir até o step 2 do modal de importar**
...
| # | Ação do passo | Resultado esperado | Status | Notas | Duração |
|---|---|---|:---:|---|---:|
| 1 | Estar no step 'Importar de outro painel' com campos preenchidos | Modal exibido | ❌ | Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')). | 42.00s |
| 2 | Clicar no botão 'Cancelar' | Modal é fechado e nenhuma aba é importada | ⊘ | Step não executado: o teste foi interrompido antes. Causa: Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')).. | — |
...
- 📸 **Screenshot (screenshot)** — [`test-failed-1.png`](artifacts/projects-widgets-tests-fea-52090-ar-abas-Cancelar-importação-chromium/test-failed-1.png)

  ![](artifacts/projects-widgets-tests-fea-52090-ar-abas-Cancelar-importação-chromium/test-failed-1.png)
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-widgets-tests-fea-52090-ar-abas-Cancelar-importação-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/widgets/reports/importar-abas_20260513-234017/artifacts/projects-widgets-tests-fea-52090-ar-abas-Cancelar-importação-chromium/trace.zip
  ```
...
- 📄 **DOM no momento da falha** — [`error-context.md`](artifacts/projects-widgets-tests-fea-52090-ar-abas-Cancelar-importação-chromium/error-context.md)

#### 🐛 Pronto para registro de bug

**Descrição do BUG:** [Normal] Cancelar importação — Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')).
...
1. 1. Estar no step 'Importar de outro painel' com campos preenchidos
1. 2. Clicar no botão 'Cancelar'

**Comportamento esperado:** Modal exibido
...
| Outros | Browser: chromium |
| Outros | runId: importar-abas_20260513-234017 |
| Outros | Duração até a falha: 44.44s |
| Outros | Step impactado: 1. 1. Criar painel, abrir Layouts e ir até o step 2 do modal de importar |

**Evidências:**

- Screenshot capturado pelo Playwright (screenshot): artifacts/projects-widgets-tests-fea-52090-ar-abas-Cancelar-importação-chromium/test-failed-1.png
- Vídeo da execução (video-1.webm): artifacts/projects-widgets-tests-fea-52090-ar-abas-Cancelar-importação-chromium/video-1.webm
- Vídeo da execução (video.webm): artifacts/projects-widgets-tests-fea-52090-ar-abas-Cancelar-importação-chromium/video.webm
- Snapshot do DOM/contexto da página (error-context.md): artifacts/projects-widgets-tests-fea-52090-ar-abas-Cancelar-importação-chromium/error-context.md
- Trace completo do Playwright (.zip) — `npx playwright show-trace`: artifacts/projects-widgets-tests-fea-52090-ar-abas-Cancelar-importação-chromium/trace.zip

<details><summary>📋 Ver texto agregado para copiar (Jira/GitHub/Linear)</summary>

```
Descrição do BUG
[Normal] Cancelar importação — Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')).
...
Passo a passo para reprodução
  ...
  1. Estar no step 'Importar de outro painel' com campos preenchidos
...
- Outros:
  - Browser: chromium
  - runId: importar-abas_20260513-234017
  - Duração até a falha: 44.44s
  - Step impactado: 1. 1. Criar painel, abrir Layouts e ir até o step 2 do modal de importar
...
<a id="editar-aba-importada"></a>_Arquivo:_ `editar-aba-importada.spec.ts` · _Duração:_ 44.45s · _Browser:_ chromium
...
| # | Ação do passo | Resultado esperado | Status | Notas | Duração |
|---|---|---|:---:|---|---:|
| 1 | Editar nome da aba já importada | Nome é editado com sucesso | ❌ | Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')). | 42.01s |
| 2 | Adicionar/Remover/Mover Widgets de aba importada | Ações são realizadas e salvas com sucesso | ⊘ | Step não executado: o teste foi interrompido antes. Causa: Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')).. | — |
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-widgets-tests-fea-fbe87-r-abas-Editar-aba-importada-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/widgets/reports/importar-abas_20260513-234017/artifacts/projects-widgets-tests-fea-fbe87-r-abas-Editar-aba-importada-chromium/trace.zip
  ```
...
**Descrição do BUG:** [Menor] Editar aba importada — Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')).
...
| Outros | Browser: chromium |
| Outros | runId: importar-abas_20260513-234017 |
| Outros | Duração até a falha: 44.45s |
...
```
Descrição do BUG
[Menor] Editar aba importada — Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')).
...
<a id="importar-aba-happy-path"></a>_Arquivo:_ `importar-aba-happy-path.spec.ts` · _Duração:_ 41.88s · _Browser:_ chromium
...
| # | Ação do passo | Resultado esperado | Status | Notas | Duração |
|---|---|---|:---:|---|---:|
| 1 | Clicar no botão 'Importar aba' | Modal é fechado, nova aba "Aba Importada" é criada e selecionada como aba ativa, toast exibida: "Aba importada com sucesso" | ❌ | Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')). | 39.82s |
| 2 | Verificar a aba importada | 'Aba Importada' é exibida e contém os 2 widgets copiados da 'Aba X' do 'Painel Origem' | ⊘ | Step não executado: o teste foi interrompido antes. Causa: Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')).. | — |
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-widgets-tests-fea-97d34-as-Importar-aba-happy-path--chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/widgets/reports/importar-abas_20260513-234017/artifacts/projects-widgets-tests-fea-97d34-as-Importar-aba-happy-path--chromium/trace.zip
  ```
...
**Descrição do BUG:** [Crítico] Importar aba (happy path) — Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')).
...
| Outros | Browser: chromium |
| Outros | runId: importar-abas_20260513-234017 |
| Outros | Duração até a falha: 41.88s |
...
```
Descrição do BUG
[Crítico] Importar aba (happy path) — Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')).
...
<a id="importar-aba-com-painel-sem-abas-disponiveis"></a>_Arquivo:_ `importar-painel-sem-abas.spec.ts` · _Duração:_ 0.61s · _Browser:_ chromium
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-widgets-tests-fea-7e252-painel-sem-abas-disponíveis-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/widgets/reports/importar-abas_20260513-234017/artifacts/projects-widgets-tests-fea-7e252-painel-sem-abas-disponíveis-chromium/trace.zip
  ```
...
<a id="selecionar-categoria-na-importacao"></a>_Arquivo:_ `selecionar-categoria-importacao.spec.ts` · _Duração:_ 42.79s · _Browser:_ chromium
...
| # | Ação do passo | Resultado esperado | Status | Notas | Duração |
|---|---|---|:---:|---|---:|
| 1 | Selecionar painel e aba no fluxo de importação | Campo 'Categoria' é exibido | ❌ | Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')). | 40.50s |
| 2 | Selecionar 'Aprendizagem' no dropdown 'Categoria' | Opção é selecionada | ⊘ | Step não executado: o teste foi interrompido antes. Causa: Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')).. | — |
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-widgets-tests-fea-98f94-nar-Categoria-na-importação-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/widgets/reports/importar-abas_20260513-234017/artifacts/projects-widgets-tests-fea-98f94-nar-Categoria-na-importação-chromium/trace.zip
  ```
...
**Descrição do BUG:** [Normal] Selecionar Categoria na importação — Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')).
...
| Outros | Browser: chromium |
| Outros | runId: importar-abas_20260513-234017 |
| Outros | Duração até a falha: 42.79s |
...
```
Descrição do BUG
[Normal] Selecionar Categoria na importação — Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')).
...
<a id="selecionar-painel-de-origem-e-listar-abas-disponiveis"></a>_Arquivo:_ `selecionar-painel-origem-listar-abas.spec.ts` · _Duração:_ 43.01s · _Browser:_ chromium
...
| # | Ação do passo | Resultado esperado | Status | Notas | Duração |
|---|---|---|:---:|---|---:|
| 1 | Iniciar o fluxo Importar de outro painel | Modal de importação é exibido com 'Painel de origem' | ❌ | Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')). | 40.67s |
| 2 | Selecionar 'Painel Origem' no select 'Painel de origem' | Campo 'Aba disponível' é exibido listando 'Aba X (2 widgets)' e 'Aba Y (3 widgets)' | ⊘ | Step não executado: o teste foi interrompido antes. Causa: Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')).. | — |
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-widgets-tests-fea-2e450-m-e-listar-abas-disponíveis-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/widgets/reports/importar-abas_20260513-234017/artifacts/projects-widgets-tests-fea-2e450-m-e-listar-abas-disponíveis-chromium/trace.zip
  ```
...
**Descrição do BUG:** [Crítico] Selecionar painel de origem e listar abas disponíveis — Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')).
...
| Outros | Browser: chromium |
| Outros | runId: importar-abas_20260513-234017 |
| Outros | Duração até a falha: 43.01s |
...
```
Descrição do BUG
[Crítico] Selecionar painel de origem e listar abas disponíveis — Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')).
...
### ❌ Falhou · TC9 · Tentar importar sem selecionar painel de origem · 🟡 Normal

<a id="tentar-importar-sem-selecionar-painel-de-origem"></a>_Arquivo:_ `tentar-importar-sem-painel.spec.ts` · _Duração:_ 42.75s · _Browser:_ chromium

> **❌ Por que falhou:** Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')).
> _Step impactado:_ **1. Criar painel e abrir modal step 2 de importar (sem seleção)**
...
| # | Ação do passo | Resultado esperado | Status | Notas | Duração |
|---|---|---|:---:|---|---:|
| 1 | Estar no step 'Importar de outro painel' sem selecionar painel | Campos seguintes ('Aba disponível', 'Nome da nova aba') não são exibidos | ❌ | Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')). | 40.56s |
| 2 | Tentar acionar 'Importar aba' (se botão estiver visível) | Botão está desabilitado ou exibe erro de campo obrigatório no 'Painel de origem' | ⊘ | Step não executado: o teste foi interrompido antes. Causa: Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')).. | — |
...
- 📸 **Screenshot (screenshot)** — [`test-failed-1.png`](artifacts/projects-widgets-tests-fea-9f900-selecionar-painel-de-origem-chromium/test-failed-1.png)

  ![](artifacts/projects-widgets-tests-fea-9f900-selecionar-painel-de-origem-chromium/test-failed-1.png)
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-widgets-tests-fea-9f900-selecionar-painel-de-origem-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/widgets/reports/importar-abas_20260513-234017/artifacts/projects-widgets-tests-fea-9f900-selecionar-painel-de-origem-chromium/trace.zip
  ```
...
- 📄 **DOM no momento da falha** — [`error-context.md`](artifacts/projects-widgets-tests-fea-9f900-selecionar-painel-de-origem-chromium/error-context.md)

#### 🐛 Pronto para registro de bug

**Descrição do BUG:** [Normal] Tentar importar sem selecionar painel de origem — Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')).

**Passo a passo para reprodução:**
1. Pré: Ambiente Stage configurado Funcionalidade 'Gestão de Painéis' habilitada no contrato Feature flag 'habilitar_paineis_do_usuario' ativa Usuário logado como Admin Modal de importação aberto
1. 1. Estar no step 'Importar de outro painel' sem selecionar painel
1. 2. Tentar acionar 'Importar aba' (se botão estiver visível)

**Comportamento esperado:** Campos seguintes ('Aba disponível', 'Nome da nova aba') não são exibidos
...
| Outros | Browser: chromium |
| Outros | runId: importar-abas_20260513-234017 |
| Outros | Duração até a falha: 42.75s |
| Outros | Step impactado: 1. 1. Criar painel e abrir modal step 2 de importar (sem seleção) |

**Evidências:**

- Screenshot capturado pelo Playwright (screenshot): artifacts/projects-widgets-tests-fea-9f900-selecionar-painel-de-origem-chromium/test-failed-1.png
- Vídeo da execução (video-1.webm): artifacts/projects-widgets-tests-fea-9f900-selecionar-painel-de-origem-chromium/video-1.webm
- Vídeo da execução (video.webm): artifacts/projects-widgets-tests-fea-9f900-selecionar-painel-de-origem-chromium/video.webm
- Snapshot do DOM/contexto da página (error-context.md): artifacts/projects-widgets-tests-fea-9f900-selecionar-painel-de-origem-chromium/error-context.md
- Trace completo do Playwright (.zip) — `npx playwright show-trace`: artifacts/projects-widgets-tests-fea-9f900-selecionar-painel-de-origem-chromium/trace.zip

<details><summary>📋 Ver texto agregado para copiar (Jira/GitHub/Linear)</summary>

```
Descrição do BUG
[Normal] Tentar importar sem selecionar painel de origem — Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')).

Passo a passo para reprodução
  Pré: Ambiente Stage configurado Funcionalidade 'Gestão de Painéis' habilitada no contrato Feature flag 'habilitar_paineis_do_usuario' ativa Usuário logado como Admin Modal de importação aberto
  1. Estar no step 'Importar de outro painel' sem selecionar painel
  2. Tentar acionar 'Importar aba' (se botão estiver visível)
...
- Outros:
  - Browser: chromium
  - runId: importar-abas_20260513-234017
  - Duração até a falha: 42.75s
  - Step impactado: 1. 1. Criar painel e abrir modal step 2 de importar (sem seleção)
...
- environment.json: staging-widgets
- testsuite: Importar abas
- testcase: Tentar importar sem selecionar painel de origem
...
<a id="visualizar-preview-da-aba-selecionada"></a>_Arquivo:_ `visualizar-preview-aba.spec.ts` · _Duração:_ 41.67s · _Browser:_ chromium
...
| # | Ação do passo | Resultado esperado | Status | Notas | Duração |
|---|---|---|:---:|---|---:|
| 1 | Selecionar 'Aba X (2 widgets)' no campo 'Aba disponível' | Preview é exibido com nome da aba, quantidade de widgets e a lista de widgets inclusos | ❌ | Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')). | 39.70s |
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-widgets-tests-fea-42643--preview-da-aba-selecionada-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/widgets/reports/importar-abas_20260513-234017/artifacts/projects-widgets-tests-fea-42643--preview-da-aba-selecionada-chromium/trace.zip
  ```
...
**Descrição do BUG:** [Crítico] Visualizar preview da aba selecionada — Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')).
...
| Outros | Browser: chromium |
| Outros | runId: importar-abas_20260513-234017 |
| Outros | Duração até a falha: 41.67s |
| Outros | Step impactado: 1. 1. Criar Painel Origem com Aba X e Aba Y seedadas |
...
```
Descrição do BUG
[Crítico] Visualizar preview da aba selecionada — Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')).
...
### ❌ Falhou · TC7 · Voltar do step de importação para a seleção de tipo · 🟡 Normal

<a id="voltar-do-step-de-importacao-para-a-selecao-de-tipo"></a>_Arquivo:_ `voltar-step-importacao.spec.ts` · _Duração:_ 42.02s · _Browser:_ chromium

> **❌ Por que falhou:** Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')).
> _Step impactado:_ **1. Criar painel, abrir Layouts e navegar até o step 2 de "Importar de outro painel"**
...
| # | Ação do passo | Resultado esperado | Status | Notas | Duração |
|---|---|---|:---:|---|---:|
| 1 | Estar no step 'Importar de outro painel' | Modal exibido com campos de painel/aba | ❌ | Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')). | 40.02s |
| 2 | Clicar no botão 'Voltar' | Modal retorna ao step de seleção entre 'Criar nova aba' e 'Importar de outro painel' | ⊘ | Step não executado: o teste foi interrompido antes. Causa: Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')).. | — |
...
- 📸 **Screenshot (screenshot)** — [`test-failed-1.png`](artifacts/projects-widgets-tests-fea-fbd59-ação-para-a-seleção-de-tipo-chromium/test-failed-1.png)

  ![](artifacts/projects-widgets-tests-fea-fbd59-ação-para-a-seleção-de-tipo-chromium/test-failed-1.png)
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-widgets-tests-fea-fbd59-ação-para-a-seleção-de-tipo-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/widgets/reports/importar-abas_20260513-234017/artifacts/projects-widgets-tests-fea-fbd59-ação-para-a-seleção-de-tipo-chromium/trace.zip
  ```
...
- 📄 **DOM no momento da falha** — [`error-context.md`](artifacts/projects-widgets-tests-fea-fbd59-ação-para-a-seleção-de-tipo-chromium/error-context.md)

#### 🐛 Pronto para registro de bug

**Descrição do BUG:** [Normal] Voltar do step de importação para a seleção de tipo — Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')).

**Passo a passo para reprodução:**
1. Pré: Ambiente Stage configurado Funcionalidade 'Gestão de Painéis' habilitada no contrato Feature flag 'habilitar_paineis_do_usuario' ativa Usuário logado como Admin Modal de importação aberto
1. 1. Estar no step 'Importar de outro painel'
1. 2. Clicar no botão 'Voltar'

**Comportamento esperado:** Modal exibido com campos de painel/aba
...
| Outros | Browser: chromium |
| Outros | runId: importar-abas_20260513-234017 |
| Outros | Duração até a falha: 42.02s |
| Outros | Step impactado: 1. 1. Criar painel, abrir Layouts e navegar até o step 2 de "Importar de outro painel" |

**Evidências:**

- Screenshot capturado pelo Playwright (screenshot): artifacts/projects-widgets-tests-fea-fbd59-ação-para-a-seleção-de-tipo-chromium/test-failed-1.png
- Vídeo da execução (video-1.webm): artifacts/projects-widgets-tests-fea-fbd59-ação-para-a-seleção-de-tipo-chromium/video-1.webm
- Vídeo da execução (video.webm): artifacts/projects-widgets-tests-fea-fbd59-ação-para-a-seleção-de-tipo-chromium/video.webm
- Snapshot do DOM/contexto da página (error-context.md): artifacts/projects-widgets-tests-fea-fbd59-ação-para-a-seleção-de-tipo-chromium/error-context.md
- Trace completo do Playwright (.zip) — `npx playwright show-trace`: artifacts/projects-widgets-tests-fea-fbd59-ação-para-a-seleção-de-tipo-chromium/trace.zip

<details><summary>📋 Ver texto agregado para copiar (Jira/GitHub/Linear)</summary>

```
Descrição do BUG
[Normal] Voltar do step de importação para a seleção de tipo — Não foi possível clicar o elemento — ele não ficou disponível em 30s (locator: getByTestId('tabs-navigation-add-button')).

Passo a passo para reprodução
  Pré: Ambiente Stage configurado Funcionalidade 'Gestão de Painéis' habilitada no contrato Feature flag 'habilitar_paineis_do_usuario' ativa Usuário logado como Admin Modal de importação aberto
  1. Estar no step 'Importar de outro painel'
...
- Outros:
  - Browser: chromium
  - runId: importar-abas_20260513-234017
  - Duração até a falha: 42.02s
  - Step impactado: 1. 1. Criar painel, abrir Layouts e navegar até o step 2 de "Importar de outro painel"
...
- environment.json: staging-widgets
- testsuite: Importar abas
- testcase: Voltar do step de importação para a seleção de tipo
