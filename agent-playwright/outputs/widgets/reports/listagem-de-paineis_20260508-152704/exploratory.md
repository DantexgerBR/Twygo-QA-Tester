...
<details><summary>📁 Fora do escopo "Widgets" — 35 erro(s) · 26 aviso(s) · 4 info _(silenciado dos KPIs principais)_</summary>

#### ❌ Acessibilidade — axe-core (65 no total · 14 regra(s) única(s))
...
- **`aria-allowed-attr`** _(critical)_ — 4 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`button-name`** _(critical)_ — 4 ocorrência(s) em 1 URL(s)
  ...
  Seletor: `#open-filter`
  ```html
  <button type="button" class="chakra-button css-1py8e62" id="open-filter">
  ```
...
- **`label`** _(critical)_ — 4 ocorrência(s) em 1 URL(s)
  ...
  Seletor: `#panel-situation-801915`
  ```html
  <input class="chakra-switch__input" type="checkbox" id="panel-situation-801915" value="" checked="" style="border: 0px; clip: rect(0px, 0px, 0px, 0px); height: 1px; width: 1px; margin: -1px; padding: 
  ```
