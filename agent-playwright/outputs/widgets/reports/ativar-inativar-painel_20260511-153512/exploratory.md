...
- `https://widgets.stage.twygoead.com/o/36988/use_modes?tab=panels-tab`
  77/152 interativos visíveis (**51%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu
- `about:blank`
  0/0 interativos visíveis (**0%**) · amostra: _(vazio)_

<details><summary>📁 Fora do escopo "Widgets" — 24 erro(s) · 11 aviso(s) · 3 info _(silenciado dos KPIs principais)_</summary>
...
|---:|---|---|---:|
| 500 | GET | `https://widgets.stage.twygoead.com/api/v1/o/36988/panels/803075/linked_menus` | 1 |
| 500 | GET | `https://widgets.stage.twygoead.com/api/v1/o/36988/panels/801944/linked_menus` | 1 |
...
- **`label`** _(critical)_ — 3 ocorrência(s) em 1 URL(s)
  ...
  Seletor: `#panel-situation-803075`
  ```html
  <input class="chakra-switch__input" type="checkbox" id="panel-situation-803075" value="" style="border: 0px; clip: rect(0px, 0px, 0px, 0px); height: 1px; width: 1px; margin: -1px; padding: 0px; overfl
  ```
