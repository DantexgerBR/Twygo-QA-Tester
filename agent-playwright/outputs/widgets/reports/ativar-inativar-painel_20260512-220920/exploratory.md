...
<details><summary>📁 Fora do escopo "Widgets" — 30 erro(s) · 8 aviso(s) · 2 info _(silenciado dos KPIs principais)_</summary>

#### ❌ Erros JavaScript no navegador (16 ocorrência(s) · 3 mensagem(ens) distinta(s))
...
#### ❌ Respostas HTTP de falha (4 no total · 4 únicas)

| Status | Método | URL | Ocorrências |
|---:|---|---|---:|
| 500 | GET | `https://widgets.stage.twygoead.com/api/v1/o/36988/panels/802998/linked_menus` | 1 |
| 422 | PATCH | `https://widgets.stage.twygoead.com/api/v1/o/36988/panels/802998/change_status` | 1 |
| 500 | GET | `https://widgets.stage.twygoead.com/api/v1/o/36988/panels/803001/linked_menus` | 1 |
| 422 | PATCH | `https://widgets.stage.twygoead.com/api/v1/o/36988/panels/803001/change_status` | 1 |

#### ❌ Acessibilidade — axe-core (20 no total · 10 regra(s) única(s))
...
- **`label`** _(critical)_ — 2 ocorrência(s) em 1 URL(s)
  ...
  Seletor: `#panel-situation-803000`
  ```html
  <input class="chakra-switch__input" type="checkbox" id="panel-situation-803000" value="" checked="" style="border: 0px; clip: rect(0px, 0px, 0px, 0px); height: 1px; width: 1px; margin: -1px; padding: 
  ```
