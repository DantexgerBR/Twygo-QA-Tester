...
#### ℹ️ Cobertura observada por URL (17)

- `https://widgets.stage.twygoead.com/o/36988/panels/803516/edit?tab=layouts`
...
- `https://widgets.stage.twygoead.com/o/36988/panels/803518/edit?tab=layouts`
...
- `https://widgets.stage.twygoead.com/o/36988/panels/803520/edit?tab=layouts`
...
- `https://widgets.stage.twygoead.com/o/36988/panels/803524/edit?tab=layouts`
  62/177 interativos visíveis (**35%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu
- `https://widgets.stage.twygoead.com/o/36988/panels/803525/edit?tab=layouts`
  55/132 interativos visíveis (**42%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu
- `https://widgets.stage.twygoead.com/o/36988/panels/803505/edit?tab=layouts`
...
- `https://widgets.stage.twygoead.com/o/36988/panels/803527/edit?tab=layouts`
  66/143 interativos visíveis (**46%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu
- `https://widgets.stage.twygoead.com/o/36988/panels/new`
  62/177 interativos visíveis (**35%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu
- `https://widgets.stage.twygoead.com/o/36988/panels/803528/edit?tab=layouts`
...
- `https://widgets.stage.twygoead.com/o/36988/panels/803501/edit?tab=layouts`
  53/130 interativos visíveis (**41%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu
- `https://widgets.stage.twygoead.com/o/36988/panels/803531/edit?tab=layouts`
  53/130 interativos visíveis (**41%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu
- `https://widgets.stage.twygoead.com/o/36988/panels/803517/edit?tab=layouts`
...
- `https://widgets.stage.twygoead.com/o/36988/panels/803533/edit?tab=layouts`
  54/131 interativos visíveis (**41%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu
- `https://widgets.stage.twygoead.com/o/36988/panels/803503/edit?tab=layouts`
  54/131 interativos visíveis (**41%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu
- `https://widgets.stage.twygoead.com/o/36988/panels/803532/edit?tab=layouts`
  54/131 interativos visíveis (**41%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu
- `https://widgets.stage.twygoead.com/o/36988/panels/803504/edit?tab=layouts`
  54/131 interativos visíveis (**41%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu

<details><summary>📁 Fora do escopo "Widgets" — 296 erro(s) · 83 aviso(s) _(silenciado dos KPIs principais)_</summary>

#### ❌ Erros JavaScript no navegador (145 ocorrência(s) · 4 mensagem(ens) distinta(s))

- **Erro JavaScript no navegador** — _56 ocorrência(s) em 28 URL(s)_
  > Failed to load resource: the server responded with a status of 500 ()
- **Erro JavaScript no navegador** — _51 ocorrência(s) em 33 URL(s)_
  > Failed to load resource: net::ERR_BLOCKED_BY_CLIENT.Inspector
- **Erro JavaScript no navegador** — _37 ocorrência(s) em 21 URL(s)_
...
- **Erro JavaScript no navegador** — _1 ocorrência(s) em 1 URL(s)_
  ...
  `https://widgets.stage.twygoead.com/o/36988/panels/803525/edit`

#### ❌ Respostas HTTP de falha (56 no total · 1 únicas)

| Status | Método | URL | Ocorrências |
|---:|---|---|---:|
| 500 | GET | `https://chat-staging.twygo.com.br/v1/notificates/all?page=1&per_page=25` | 56 |

#### ❌ Acessibilidade — axe-core (178 no total · 14 regra(s) única(s))

- **`color-contrast`** _(serious)_ — 17 ocorrência(s) em 17 URL(s)
  ...
  ```
- **`landmark-unique`** _(moderate)_ — 17 ocorrência(s) em 17 URL(s)
  ...
  ```
- **`meta-viewport`** _(moderate)_ — 17 ocorrência(s) em 17 URL(s)
  ...
  ```
- **`region`** _(moderate)_ — 17 ocorrência(s) em 17 URL(s)
  ...
  ```
- **`aria-allowed-attr`** _(critical)_ — 16 ocorrência(s) em 16 URL(s)
  ...
  ```
- **`image-alt`** _(critical)_ — 16 ocorrência(s) em 16 URL(s)
  ...
  ```
- **`label`** _(critical)_ — 16 ocorrência(s) em 16 URL(s)
  ...
  ```
- **`landmark-one-main`** _(moderate)_ — 16 ocorrência(s) em 16 URL(s)
  ...
  ```
- **`list`** _(serious)_ — 16 ocorrência(s) em 16 URL(s)
  ...
  <ul class="menu-main">
  ```
- **`page-has-heading-one`** _(moderate)_ — 16 ocorrência(s) em 16 URL(s)
  ...
  <html lang="en" xml:lang="en" xmlns="http://www.w3.org/1999/xhtml" class="wf-materialicons-n4-inactive wf-materialsymbolsoutlined-n4-inactive wf-inactive" data-theme="light" style="color-scheme: light
  ```
- **`aria-progressbar-name`** _(serious)_ — 5 ocorrência(s) em 5 URL(s)
  ...
  ```
- **`aria-command-name`** _(serious)_ — 3 ocorrência(s) em 3 URL(s)
  ...
  ```
- **`aria-input-field-name`** _(serious)_ — 3 ocorrência(s) em 3 URL(s)
  ...
  ```
- **`button-name`** _(critical)_ — 3 ocorrência(s) em 3 URL(s)
