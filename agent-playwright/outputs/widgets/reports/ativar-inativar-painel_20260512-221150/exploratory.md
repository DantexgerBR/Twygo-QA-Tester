...
- `https://widgets.stage.twygoead.com/o/36988/use_modes?tab=panels-tab`
  80/156 interativos visíveis (**51%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: users-menu · link: companies-menu · link: question_lists-menu
- `about:blank`
  0/0 interativos visíveis (**0%**) · amostra: _(vazio)_

<details><summary>📁 Fora do escopo "Widgets" — 54 erro(s) · 14 aviso(s) · 3 info _(silenciado dos KPIs principais)_</summary>

#### ❌ Erros JavaScript no navegador (31 ocorrência(s) · 5 mensagem(ens) distinta(s))

- **Erro JavaScript no navegador** — _21 ocorrência(s) em 1 URL(s)_
...
#### ❌ Respostas HTTP de falha (6 no total · 6 únicas)

| Status | Método | URL | Ocorrências |
|---:|---|---|---:|
| 500 | GET | `https://widgets.stage.twygoead.com/api/v1/o/36988/panels/803002/linked_menus` | 1 |
| 422 | PATCH | `https://widgets.stage.twygoead.com/api/v1/o/36988/panels/803002/change_status` | 1 |
| 500 | GET | `https://widgets.stage.twygoead.com/api/v1/o/36988/panels/803004/linked_menus` | 1 |
| 422 | PATCH | `https://widgets.stage.twygoead.com/api/v1/o/36988/panels/803004/change_status` | 1 |
| 500 | GET | `https://widgets.stage.twygoead.com/api/v1/o/36988/panels/803006/linked_menus` | 1 |
| 422 | PATCH | `https://widgets.stage.twygoead.com/api/v1/o/36988/panels/803006/change_status` | 1 |

#### ❌ Acessibilidade — axe-core (34 no total · 14 regra(s) única(s))
...
- **`label`** _(critical)_ — 3 ocorrência(s) em 1 URL(s)
  ...
  Seletor: `#panel-situation-803005`
  ```html
  <input class="chakra-switch__input" type="checkbox" id="panel-situation-803005" value="" checked="" style="border: 0px; clip: rect(0px, 0px, 0px, 0px); height: 1px; width: 1px; margin: -1px; padding: 
  ```
- **`landmark-unique`** _(moderate)_ — 3 ocorrência(s) em 1 URL(s)
...
- **`list`** _(serious)_ — 3 ocorrência(s) em 1 URL(s)
  ...
  <ul class="menu-main">
  ```
- **`meta-viewport`** _(moderate)_ — 3 ocorrência(s) em 1 URL(s)
