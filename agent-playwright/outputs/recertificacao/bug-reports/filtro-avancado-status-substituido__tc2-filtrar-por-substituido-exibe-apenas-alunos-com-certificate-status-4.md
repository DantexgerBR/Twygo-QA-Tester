...
- **Passo-a-passo**:
  ...
  2. 2. Abrir o filtro avançado de "Status do certificado", marcar APENAS a opção "Substituído" e aplicar → Drawer fecha, listagem refilra — ❌ **falhou aqui**
