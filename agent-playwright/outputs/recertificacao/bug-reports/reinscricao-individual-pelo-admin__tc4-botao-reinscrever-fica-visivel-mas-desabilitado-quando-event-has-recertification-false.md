...
- **Erro em**: `C:\Claude\Recertificação\twygo-agents-qa\agent-playwright\projects\recertificacao\tests\features\reinscricao-individual-pelo-admin\tc4-botao-reinscrever-disabled-has-recertification-false.spec.ts:36:74`
- **Status**: failed (13219ms)
...
- **Passo-a-passo**:
  1. 1. Pré-condição: curso "Curso sem Reinscrição w0" com has_recertification=false e 1 aluno elegível — ✅
  2. 2. Acessar lista de aprendizagem do curso → Aluno elegível listado — ❌ **falhou aqui**
...
- **Observado**:
  ...
  Locator: locator('tbody tr').filter({ hasText: 'aluno.elegivel.sem.reinscricao@example.com' }).first()
  Expected: visible
  Timeout: 10000ms
...
|---|---|---|---|---|
| GET | `https://basedeconhecimento.stage.twygoead.com/o/37007/events/2/learning_students` | **404** | não | — |
