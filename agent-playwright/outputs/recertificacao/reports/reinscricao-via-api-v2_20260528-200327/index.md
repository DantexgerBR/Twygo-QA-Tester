...
**Projeto:** Recertificação · **Ambiente:** `staging-recertificacao` · **Browsers:** chromium · **Gerado em:** 28/05/2026, 20:03:27

> **Escopo:** Apenas testsuite contendo "Reinscrição via API V2"

> ✅ **Nenhuma falha registrada** — todos os 3 caso(s) executado(s) foram aprovados.
...
|---|---:|---|---:|---:|---:|---|---:|
| **Reinscrição via API V2** | 3 | `[█████████████⊘⊘⊘⊘⊘⊘⊘]` 2/0/1 | 67% | 0 | 1 | — | 1.6s |
