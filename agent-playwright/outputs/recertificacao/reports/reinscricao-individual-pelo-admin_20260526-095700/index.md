...
**Projeto:** Recertificação · **Ambiente:** `staging-base-de-conhecimento` · **Browsers:** chromium · **Gerado em:** 26/05/2026, 09:57:00

> **Escopo:** Apenas testsuite contendo "Reinscrição Individual pelo Admin"

> ✅ **Nenhuma falha registrada** — todos os 6 caso(s) executado(s) foram aprovados.
