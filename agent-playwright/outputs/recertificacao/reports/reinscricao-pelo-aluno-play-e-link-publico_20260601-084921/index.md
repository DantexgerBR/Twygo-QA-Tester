...
**Projeto:** Recertificação · **Ambiente:** `staging-recertificacao` · **Browsers:** chromium · **Gerado em:** 01/06/2026, 08:49:21

> **Escopo:** Apenas testsuite contendo "Reinscrição pelo Aluno (Play e Link Público)"

> ✅ **Nenhuma falha registrada** — todos os 7 caso(s) executado(s) foram aprovados.
...
|---|---:|---|---:|---:|---:|---|---:|
| **Reinscrição pelo Aluno (Play e Link Público)** | 7 | `[⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘]` 0/0/7 | 0% | 0 | 7 | — | 6.9s |
