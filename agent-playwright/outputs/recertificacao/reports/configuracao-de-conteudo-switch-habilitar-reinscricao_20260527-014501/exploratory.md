...
- `https://recertificacao-testeqa.stage.twygoead.com/o/37048/events`
  64/474 interativos visíveis (**14%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: content_models-menu · link: knowledge_repositories-menu · link: users-menu
- `https://recertificacao-testeqa.stage.twygoead.com/contents/807017/edit`
...
- `https://recertificacao-testeqa.stage.twygoead.com/e/807015/edit`
  87/172 interativos visíveis (**51%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: content_models-menu · link: knowledge_repositories-menu · link: users-menu
...
|---:|---|---|---:|
| 404 | GET | `https://recertificacao-testeqa.stage.twygoead.com/contents/807017/edit` | 1 |
...
- **`aria-allowed-attr`** _(critical)_ — 1 ocorrência(s) em 1 URL(s)
  ...
  Seletor: `#menu-button-\:r18\:`
  ```html
  <svg viewBox="0 0 482.575 511.9" focusable="false" class="chakra-icon chakra-menu__menu-button css-1y85x2" aria-label="Options" id="menu-button-:r18:" aria-expanded="false" aria-haspopup="menu" aria-c
  ```
...
- **`nested-interactive`** _(serious)_ — 1 ocorrência(s) em 1 URL(s)
  ...
  Seletor: `.css-kjvu41`
  ```html
  <button id="menu-button-:rn:" aria-expanded="false" aria-haspopup="menu" aria-controls="menu-list-:rn:" class="chakra-menu__menu-button css-kjvu41">
  ```
