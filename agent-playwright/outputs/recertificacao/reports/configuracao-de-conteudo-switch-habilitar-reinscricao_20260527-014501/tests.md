...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-recertificacao-te-d835b--flag-ON-na-edição-de-curso-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/recertificacao/reports/configuracao-de-conteudo-switch-habilitar-reinscricao_20260527-014501/artifacts/projects-recertificacao-te-d835b--flag-ON-na-edição-de-curso-chromium/trace.zip
  ```
...
**Descrição do BUG:** [—] TC1 — Switch "Habilitar reinscrição" aparece com flag ON na edição de curso — TimeoutError: locator.innerText: Timeout 30000ms exceeded.
...
| Outros | runId: configuracao-de-conteudo-switch-habilitar-reinscricao_20260527-014501 |
...
```
Descrição do BUG
[—] TC1 — Switch "Habilitar reinscrição" aparece com flag ON na edição de curso — TimeoutError: locator.innerText: Timeout 30000ms exceeded.
...
- Outros:
  - Browser: chromium
  - runId: configuracao-de-conteudo-switch-habilitar-reinscricao_20260527-014501
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-recertificacao-te-ccb33-e-has-recertification-true--chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/recertificacao/reports/configuracao-de-conteudo-switch-habilitar-reinscricao_20260527-014501/artifacts/projects-recertificacao-te-ccb33-e-has-recertification-true--chromium/trace.zip
  ```
...
**Descrição do BUG:** [—] TC3 — Ativar e salvar o switch persiste `has_recertification = true` — TimeoutError: locator.innerText: Timeout 30000ms exceeded.
...
```
Descrição do BUG
[—] TC3 — Ativar e salvar o switch persiste `has_recertification = true` — TimeoutError: locator.innerText: Timeout 30000ms exceeded.
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-recertificacao-te-ad265-ritos-é-permitido-sem-aviso-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/recertificacao/reports/configuracao-de-conteudo-switch-habilitar-reinscricao_20260527-014501/artifacts/projects-recertificacao-te-ad265-ritos-é-permitido-sem-aviso-chromium/trace.zip
  ```
...
**Descrição do BUG:** [—] TC4 — Desativar o switch em curso com participants reinscritos é permitido sem aviso — TimeoutError: locator.innerText: Timeout 30000ms exceeded.
...
```
Descrição do BUG
[—] TC4 — Desativar o switch em curso com participants reinscritos é permitido sem aviso — TimeoutError: locator.innerText: Timeout 30000ms exceeded.
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-recertificacao-te-254b9--formulário-React-facelift--chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/recertificacao/reports/configuracao-de-conteudo-switch-habilitar-reinscricao_20260527-014501/artifacts/projects-recertificacao-te-254b9--formulário-React-facelift--chromium/trace.zip
  ```
...
**Descrição do BUG:** [—] TC5 — Paridade do switch entre formulário HAML e formulário React (facelift) — TimeoutError: locator.innerText: Timeout 30000ms exceeded.
...
```
Descrição do BUG
[—] TC5 — Paridade do switch entre formulário HAML e formulário React (facelift) — TimeoutError: locator.innerText: Timeout 30000ms exceeded.
