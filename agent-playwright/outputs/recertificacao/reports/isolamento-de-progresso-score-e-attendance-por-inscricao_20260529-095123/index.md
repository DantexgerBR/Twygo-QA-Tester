...
**Projeto:** Recertificação · **Ambiente:** `staging-recertificacao` · **Browsers:** chromium · **Gerado em:** 29/05/2026, 09:51:23
...
|---|---:|---|---:|---:|---:|---|---:|
| **Isolamento de Progresso, Score e Attendance por Inscrição** | 4 | `[⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘]` 0/0/4 | 0% | 0 | 4 | — | 156.1s |
