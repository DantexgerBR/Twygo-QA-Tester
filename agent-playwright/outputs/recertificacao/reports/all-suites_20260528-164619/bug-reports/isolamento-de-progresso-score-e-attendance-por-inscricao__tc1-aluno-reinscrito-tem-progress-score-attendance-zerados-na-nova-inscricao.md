...
- **Erro em**: `C:\Claude\Recertificação\twygo-agents-qa\agent-playwright\projects\recertificacao\tests\features\isolamento-de-progresso-score-e-attendance-por-inscricao\tc1-progresso-score-attendance-zerados.spec.ts:112:11`
- **Status**: failed (24032ms)
