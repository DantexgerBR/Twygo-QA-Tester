...
_5 caso(s) — 0 aprovado(s), 3 falha(s), 2 ignorado(s)_
...
> **❌ Por que falhou:** Error: apiRequestContext._wrapApiCall: ENOENT: no such file or directory, open 'C:\Claude\Recertificação\twygo-agents-qa\agent-playwright\outputs\recertificacao\test-artifacts\.playwright-artifacts-0\traces\e050204b338df394c0ba-b5dabc3a5064
...
|---|---|---|:---:|---|---:|
| 1 | Acessar a URL "/o/{orgId}/dashboard" | Dashboard padrão é exibido contendo o menu lateral. | ⊘ | Step não executado: o teste foi interrompido antes. Causa: Error: apiRequestContext._wrapApiCall: ENOENT: no such file or directory, open 'C:\Claude\Recertificação\twygo-agents-qa\agent-playwright\outputs\recertificacao\test-artifacts\.playwright-artifacts-0\traces\e050204b338df394c0ba-b5dabc3a5064 ... [truncado, 257 chars total]. | — |
| 2 | Navegar até a listagem de cursos da organização | Listagem de cursos é exibida com pelo menos 1 curso pré-existente. | ⊘ | Step não executado: o teste foi interrompido antes. Causa: Error: apiRequestContext._wrapApiCall: ENOENT: no such file or directory, open 'C:\Claude\Recertificação\twygo-agents-qa\agent-playwright\outputs\recertificacao\test-artifacts\.playwright-artifacts-0\traces\e050204b338df394c0ba-b5dabc3a5064 ... [truncado, 257 chars total]. | — |
| 3 | Clicar no botão `more_vert` da linha do curso → "Gerenciar" | Página de edição do curso é exibida na rota `/o/{orgId}/contents/{id}/edit?tab=identification` (aba "Identificação" ativa por default). | ⊘ | Step não executado: o teste foi interrompido antes. Causa: Error: apiRequestContext._wrapApiCall: ENOENT: no such file or directory, open 'C:\Claude\Recertificação\twygo-agents-qa\agent-playwright\outputs\recertificacao\test-artifacts\.playwright-artifacts-0\traces\e050204b338df394c0ba-b5dabc3a5064 ... [truncado, 257 chars total]. | — |
| 4 | Clicar na aba "Acesso" do formulário de edição | URL atualiza para `?tab=access` e tabpanel "Acesso" renderiza, contendo a seção "Inscrição" → "Permitir registro de inscrição por". | ⊘ | Step não executado: o teste foi interrompido antes. Causa: Error: apiRequestContext._wrapApiCall: ENOENT: no such file or directory, open 'C:\Claude\Recertificação\twygo-agents-qa\agent-playwright\outputs\recertificacao\test-artifacts\.playwright-artifacts-0\traces\e050204b338df394c0ba-b5dabc3a5064 ... [truncado, 257 chars total]. | — |
| 5 | Localizar o checkbox "Habilitar reinscrição" dentro da seção "Permitir registro de inscrição por" | Checkbox "Habilitar reinscrição" está visível no formulário (controle HTML padrão, não Chakra switch). | ⊘ | Step não executado: o teste foi interrompido antes. Causa: Error: apiRequestContext._wrapApiCall: ENOENT: no such file or directory, open 'C:\Claude\Recertificação\twygo-agents-qa\agent-playwright\outputs\recertificacao\test-artifacts\.playwright-artifacts-0\traces\e050204b338df394c0ba-b5dabc3a5064 ... [truncado, 257 chars total]. | — |
| 6 | Posicionar o cursor sobre o ícone de ajuda do checkbox "Habilitar reinscrição" | Tooltip de ajuda é exibido com o texto da chave I18n "activerecord.attributes.event.has_recertification_tooltip". | ⊘ | Step não executado: o teste foi interrompido antes. Causa: Error: apiRequestContext._wrapApiCall: ENOENT: no such file or directory, open 'C:\Claude\Recertificação\twygo-agents-qa\agent-playwright\outputs\recertificacao\test-artifacts\.playwright-artifacts-0\traces\e050204b338df394c0ba-b5dabc3a5064 ... [truncado, 257 chars total]. | — |
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-recertificacao-te-d835b--flag-ON-na-edição-de-curso-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/recertificacao/reports/all-suites_20260528-164619/artifacts/projects-recertificacao-te-d835b--flag-ON-na-edição-de-curso-chromium/trace.zip
  ```
...
1. 3. Clicar no botão `more_vert` da linha do curso → "Gerenciar"
1. 4. Clicar na aba "Acesso" do formulário de edição
1. 5. Localizar o checkbox "Habilitar reinscrição" dentro da seção "Permitir registro de inscrição por"
1. 6. Posicionar o cursor sobre o ícone de ajuda do checkbox "Habilitar reinscrição"

**Comportamento esperado:** 1. Dashboard padrão é exibido contendo o menu lateral. | 2. Listagem de cursos é exibida com pelo menos 1 curso pré-existente. | 3. Página de edição do curso é exibida na rota `/o/{orgId}/contents/{id}/edit?tab=identification` (aba "Identificação" ativa por default). | 4. URL atualiza para `?tab=access` e tabpanel "Acesso" renderiza, contendo a seção "Inscrição" → "Permitir registro de inscrição por". | 5. Checkbox "Habilitar reinscrição" está visível no formulário (controle HTML padrão, não Chakra switch). | 6. Tooltip de ajuda é exibido com o texto da chave I18n "activerecord.attributes.event.has_recertification_tooltip".

**Comportamento atual:** Error: apiRequestContext._wrapApiCall: ENOENT: no such file or directory, open 'C:\Claude\Recertificação\twygo-agents-qa\agent-playwright\outputs\recertificacao\test-artifacts\.playwright-artifacts-0\traces\e050204b338df394c0ba-b5dabc3a5064
... [truncado, 257 chars total]
...
| Outros | runId: all-suites_20260528-164619 |
...
1. Dashboard padrão é exibido contendo o menu lateral. | 2. Listagem de cursos é exibida com pelo menos 1 curso pré-existente. | 3. Página de edição do curso é exibida na rota `/o/{orgId}/contents/{id}/edit?tab=identification` (aba "Identificação" ativa por default). | 4. URL atualiza para `?tab=access` e tabpanel "Acesso" renderiza, contendo a seção "Inscrição" → "Permitir registro de inscrição por". | 5. Checkbox "Habilitar reinscrição" está visível no formulário (controle HTML padrão, não Chakra switch). | 6. Tooltip de ajuda é exibido com o texto da chave I18n "activerecord.attributes.event.has_recertification_tooltip".

Comportamento atual
Error: apiRequestContext._wrapApiCall: ENOENT: no such file or directory, open 'C:\Claude\Recertificação\twygo-agents-qa\agent-playwright\outputs\recertificacao\test-artifacts\.playwright-artifacts-0\traces\e050204b338df394c0ba-b5dabc3a5064
... [truncado, 257 chars total]
...
- Outros:
  - Browser: chromium
  - runId: all-suites_20260528-164619
...
> **❌ Por que falhou:** Error: apiRequestContext._wrapApiCall: ENOENT: no such file or directory, open 'C:\Claude\Recertificação\twygo-agents-qa\agent-playwright\outputs\recertificacao\test-artifacts\.playwright-artifacts-1\traces\ba81cb6a8ed721d18cdd-a3dc2048d10f
... [truncado, 257 chars total]
...
| # | Ação do passo | Resultado esperado | Status | Notas | Duração |
|---|---|---|:---:|---|---:|
| 1 | Acessar a edição de um curso com `has_recertification = false` | Página de edição é exibida e switch "Habilitar reinscrição" está visível e desligado. | ⊘ | Step não executado: o teste foi interrompido antes. Causa: Error: apiRequestContext._wrapApiCall: ENOENT: no such file or directory, open 'C:\Claude\Recertificação\twygo-agents-qa\agent-playwright\outputs\recertificacao\test-artifacts\.playwright-artifacts-1\traces\ba81cb6a8ed721d18cdd-a3dc2048d10f ... [truncado, 257 chars total]. | — |
| 2 | Clicar no switch "Habilitar reinscrição" | Switch transita para o estado ligado (ON). | ⊘ | Step não executado: o teste foi interrompido antes. Causa: Error: apiRequestContext._wrapApiCall: ENOENT: no such file or directory, open 'C:\Claude\Recertificação\twygo-agents-qa\agent-playwright\outputs\recertificacao\test-artifacts\.playwright-artifacts-1\traces\ba81cb6a8ed721d18cdd-a3dc2048d10f ... [truncado, 257 chars total]. | — |
| 3 | Clicar no botão "Salvar" | Toast de sucesso é exibido (REVISAR-FIGMA: texto exato do toast). | ⊘ | Step não executado: o teste foi interrompido antes. Causa: Error: apiRequestContext._wrapApiCall: ENOENT: no such file or directory, open 'C:\Claude\Recertificação\twygo-agents-qa\agent-playwright\outputs\recertificacao\test-artifacts\.playwright-artifacts-1\traces\ba81cb6a8ed721d18cdd-a3dc2048d10f ... [truncado, 257 chars total]. | — |
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-recertificacao-te-ccb33-e-has-recertification-true--chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/recertificacao/reports/all-suites_20260528-164619/artifacts/projects-recertificacao-te-ccb33-e-has-recertification-true--chromium/trace.zip
  ```
...
**Descrição do BUG:** [Crítico] TC3 — Ativar e salvar o switch persiste `has_recertification = true` — Error: apiRequestContext._wrapApiCall: ENOENT: no such file or directory, open 'C:\Claude\Recertificação\twygo-agents-qa\agent-playwright\outputs\recertificacao\test-artifacts\.playwright-artifacts-1\traces\ba81cb6a8ed721d18cdd-a3dc2048d10f
... [truncado, 257 chars total]
...
**Comportamento esperado:** 1. Página de edição é exibida e switch "Habilitar reinscrição" está visível e desligado. | 2. Switch transita para o estado ligado (ON). | 3. Toast de sucesso é exibido (REVISAR-FIGMA: texto exato do toast). | 4. Switch "Habilitar reinscrição" continua no estado ligado, refletindo o valor persistido `has_recertification = true`.

**Comportamento atual:** Error: apiRequestContext._wrapApiCall: ENOENT: no such file or directory, open 'C:\Claude\Recertificação\twygo-agents-qa\agent-playwright\outputs\recertificacao\test-artifacts\.playwright-artifacts-1\traces\ba81cb6a8ed721d18cdd-a3dc2048d10f
... [truncado, 257 chars total]
...
```
Descrição do BUG
[Crítico] TC3 — Ativar e salvar o switch persiste `has_recertification = true` — Error: apiRequestContext._wrapApiCall: ENOENT: no such file or directory, open 'C:\Claude\Recertificação\twygo-agents-qa\agent-playwright\outputs\recertificacao\test-artifacts\.playwright-artifacts-1\traces\ba81cb6a8ed721d18cdd-a3dc2048d10f
... [truncado, 257 chars total]
...
Comportamento esperado
1. Página de edição é exibida e switch "Habilitar reinscrição" está visível e desligado. | 2. Switch transita para o estado ligado (ON). | 3. Toast de sucesso é exibido (REVISAR-FIGMA: texto exato do toast). | 4. Switch "Habilitar reinscrição" continua no estado ligado, refletindo o valor persistido `has_recertification = true`.

Comportamento atual
Error: apiRequestContext._wrapApiCall: ENOENT: no such file or directory, open 'C:\Claude\Recertificação\twygo-agents-qa\agent-playwright\outputs\recertificacao\test-artifacts\.playwright-artifacts-1\traces\ba81cb6a8ed721d18cdd-a3dc2048d10f
... [truncado, 257 chars total]
...
> **❌ Por que falhou:** Error: apiRequestContext._wrapApiCall: ENOENT: no such file or directory, open 'C:\Claude\Recertificação\twygo-agents-qa\agent-playwright\outputs\recertificacao\test-artifacts\.playwright-artifacts-2\traces\2ab4896513641b86a513-385b09b41406
... [truncado, 257 chars total]
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-recertificacao-te-ad265-ritos-é-permitido-sem-aviso-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/recertificacao/reports/all-suites_20260528-164619/artifacts/projects-recertificacao-te-ad265-ritos-é-permitido-sem-aviso-chromium/trace.zip
  ```
...
**Descrição do BUG:** [Crítico] TC4 — Desativar o switch em curso com participants reinscritos é permitido sem aviso — Error: apiRequestContext._wrapApiCall: ENOENT: no such file or directory, open 'C:\Claude\Recertificação\twygo-agents-qa\agent-playwright\outputs\recertificacao\test-artifacts\.playwright-artifacts-2\traces\2ab4896513641b86a513-385b09b41406
... [truncado, 257 chars total]
...
**Comportamento atual:** Error: apiRequestContext._wrapApiCall: ENOENT: no such file or directory, open 'C:\Claude\Recertificação\twygo-agents-qa\agent-playwright\outputs\recertificacao\test-artifacts\.playwright-artifacts-2\traces\2ab4896513641b86a513-385b09b41406
... [truncado, 257 chars total]
...
```
Descrição do BUG
[Crítico] TC4 — Desativar o switch em curso com participants reinscritos é permitido sem aviso — Error: apiRequestContext._wrapApiCall: ENOENT: no such file or directory, open 'C:\Claude\Recertificação\twygo-agents-qa\agent-playwright\outputs\recertificacao\test-artifacts\.playwright-artifacts-2\traces\2ab4896513641b86a513-385b09b41406
... [truncado, 257 chars total]
...
Comportamento atual
Error: apiRequestContext._wrapApiCall: ENOENT: no such file or directory, open 'C:\Claude\Recertificação\twygo-agents-qa\agent-playwright\outputs\recertificacao\test-artifacts\.playwright-artifacts-2\traces\2ab4896513641b86a513-385b09b41406
... [truncado, 257 chars total]
...
_6 caso(s) — 0 aprovado(s), 1 falha(s), 5 ignorado(s)_
...
> **⊘ Por que foi ignorado:** Marcado para revisão (test.fixme): seed-roadmap-atividade-aula-1 + seed-roadmap-cert-expiracao-1: pré-condições "aluno progresso 100%" e "aluno cert expirado" precisam de helpers ainda não implementados. Ver skill provisionar-seed v1.6 §"Catálogo COMPLETO".
...
| # | Ação do passo | Resultado esperado | Status | Notas | Duração |
|---|---|---|:---:|---|---:|
| 1 | Acessar a lista de aprendizagem do curso em "/learning_students?event_id={eventId}" | Lista de alunos é exibida com pelo menos os 3 alunos pré-condicionados. | ⊘ | Step não executado — Marcado para revisão (test.fixme): seed-roadmap-atividade-aula-1 + seed-roadmap-cert-expiracao-1: pré-condições "aluno progresso 100%" e "aluno cert expirado" precisam de helpers ainda não implementados. Ver skill provisionar-seed v1.6 §"Catálogo COMPLETO". | — |
| 2 | Abrir o menu de ações da linha do aluno "(a) elegível por progresso 100%" | Menu de ações é exibido contendo o item "Reinscrever" habilitado (sem tooltip de bloqueio). | ⊘ | Step não executado — Marcado para revisão (test.fixme): seed-roadmap-atividade-aula-1 + seed-roadmap-cert-expiracao-1: pré-condições "aluno progresso 100%" e "aluno cert expirado" precisam de helpers ainda não implementados. Ver skill provisionar-seed v1.6 §"Catálogo COMPLETO". | — |
| 3 | Clicar fora para fechar o menu e abrir o menu da linha do aluno "(b) elegível por certificado expirado" | Menu exibe o item "Reinscrever" habilitado. | ⊘ | Step não executado — Marcado para revisão (test.fixme): seed-roadmap-atividade-aula-1 + seed-roadmap-cert-expiracao-1: pré-condições "aluno progresso 100%" e "aluno cert expirado" precisam de helpers ainda não implementados. Ver skill provisionar-seed v1.6 §"Catálogo COMPLETO". | — |
| 4 | Abrir o menu da linha do aluno "(c) inelegível em andamento" | Item "Reinscrever" é exibido mas DESABILITADO; ao posicionar o cursor sobre o item, tooltip explicativo de inelegibilidade é exibido (REVISAR-FIGMA: confirmar texto). | ⊘ | Step não executado — Marcado para revisão (test.fixme): seed-roadmap-atividade-aula-1 + seed-roadmap-cert-expiracao-1: pré-condições "aluno progresso 100%" e "aluno cert expirado" precisam de helpers ainda não implementados. Ver skill provisionar-seed v1.6 §"Catálogo COMPLETO". | — |
...
- **Severidade do caso (XML):** Crítico
- **Motivo declarado pelo spec:** seed-roadmap-atividade-aula-1 + seed-roadmap-cert-expiracao-1: pré-condições "aluno progresso 100%" e "aluno cert expirado" precisam de helpers ainda não implementados. Ver skill provisionar-seed v1.6 §"Catálogo COMPLETO".
- **Categoria:** _não declarada_ — pra próxima revisão, ajustar o spec para `test.fixme(true, '[Categoria] motivo')` com uma das categorias canônicas (xml-desatualizado | seed-ausente | dep-externa | bloqueio-temporario).
...
> **⊘ Por que foi ignorado:** Marcado para revisão (test.fixme): seed-roadmap-multi-recert-1 + seed-roadmap-atividade-aula-1: pré-condição "aluno multi-reinscrição (2 participants)" exige criar 2º participant via reinscrição, que por sua vez exige aluno aprovado (atividades + completar). Ver skill provisionar-seed v1.6.
...
- **Motivo declarado pelo spec:** seed-roadmap-multi-recert-1 + seed-roadmap-atividade-aula-1: pré-condição "aluno multi-reinscrição (2 participants)" exige criar 2º participant via reinscrição, que por sua vez exige aluno aprovado (atividades + completar). Ver skill provisionar-seed v1.6.
- **Categoria:** _não declarada_ — pra próxima revisão, ajustar o spec para `test.fixme(true, '[Categoria] motivo')` com uma das categorias canônicas (xml-desatualizado | seed-ausente | dep-externa | bloqueio-temporario).
...
> **⊘ Por que foi ignorado:** Marcado para revisão (test.fixme): seed-roadmap-atividade-aula-1: pré-condição "aluno elegível por progresso 100%" exige curso com atividades pra completar — helper de criação de atividades ainda não implementado. cursoComRecertificacaoSeed cobre só o switch. Ver skill provisionar-seed v1.6.
...
| # | Ação do passo | Resultado esperado | Status | Notas | Duração |
|---|---|---|:---:|---|---:|
| 1 | Acessar a lista de aprendizagem do curso em "/learning_students?event_id={eventId}" | Lista exibe aluno "(a) elegível" com `recertification_number = N`. | ⊘ | Step não executado — Marcado para revisão (test.fixme): seed-roadmap-atividade-aula-1: pré-condição "aluno elegível por progresso 100%" exige curso com atividades pra completar — helper de criação de atividades ainda não implementado. cursoComRecertificacaoSeed cobre só o switch. Ver skill provisionar-seed v1.6. | — |
| 2 | Clicar no item "Reinscrever" no menu da linha | Modal de confirmação "Confirmar reinscrição" é exibido (REVISAR-FIGMA: header e body exatos). | ⊘ | Step não executado — Marcado para revisão (test.fixme): seed-roadmap-atividade-aula-1: pré-condição "aluno elegível por progresso 100%" exige curso com atividades pra completar — helper de criação de atividades ainda não implementado. cursoComRecertificacaoSeed cobre só o switch. Ver skill provisionar-seed v1.6. | — |
| 3 | Clicar em "Confirmar" | Modal fecha, toast de sucesso é exibido (REVISAR-FIGMA: texto exato); tabela faz refetch automático. | ⊘ | Step não executado — Marcado para revisão (test.fixme): seed-roadmap-atividade-aula-1: pré-condição "aluno elegível por progresso 100%" exige curso com atividades pra completar — helper de criação de atividades ainda não implementado. cursoComRecertificacaoSeed cobre só o switch. Ver skill provisionar-seed v1.6. | — |
| 4 | Localizar a linha do aluno na listagem | Aluno aparece com `recertification_number = N+1`, `progress_score = 0`, badge de status "Pendente" (REVISAR-FIGMA: texto exato), sem nota e sem certificado. | ⊘ | Step não executado — Marcado para revisão (test.fixme): seed-roadmap-atividade-aula-1: pré-condição "aluno elegível por progresso 100%" exige curso com atividades pra completar — helper de criação de atividades ainda não implementado. cursoComRecertificacaoSeed cobre só o switch. Ver skill provisionar-seed v1.6. | — |
...
- **Severidade do caso (XML):** Crítico
- **Motivo declarado pelo spec:** seed-roadmap-atividade-aula-1: pré-condição "aluno elegível por progresso 100%" exige curso com atividades pra completar — helper de criação de atividades ainda não implementado. cursoComRecertificacaoSeed cobre só o switch. Ver skill provisionar-seed v1.6.
- **Categoria:** _não declarada_ — pra próxima revisão, ajustar o spec para `test.fixme(true, '[Categoria] motivo')` com uma das categorias canônicas (xml-desatualizado | seed-ausente | dep-externa | bloqueio-temporario).
...
### ❌ Falhou · TC4 — Botão "Reinscrever" fica visível mas DESABILITADO quando event.has_recertification = false 

<a id="tc4-botao-reinscrever-fica-visivel-mas-desabilitado-quando-event-has-recertification-false"></a>_Arquivo:_ `tc4-botao-reinscrever-disabled-has-recertification-false.spec.ts` · _Duração:_ 31.93s · _Browser:_ chromium

> **❌ Por que falhou:** TimeoutError: locator.innerText: Timeout 30000ms exceeded.
...
📁 _Pasta:_ [`artifacts/projects-recertificacao-te-6e331-t-has-recertification-false-chromium/`](artifacts/projects-recertificacao-te-6e331-t-has-recertification-false-chromium/)

- 📸 **Screenshot (screenshot)** — [`test-failed-1.png`](artifacts/projects-recertificacao-te-6e331-t-has-recertification-false-chromium/test-failed-1.png)

  ![](artifacts/projects-recertificacao-te-6e331-t-has-recertification-false-chromium/test-failed-1.png)

- 📸 **Screenshot (screenshot)** — [`test-failed-2.png`](artifacts/projects-recertificacao-te-6e331-t-has-recertification-false-chromium/test-failed-2.png)

  ![](artifacts/projects-recertificacao-te-6e331-t-has-recertification-false-chromium/test-failed-2.png)

- 🎬 [Vídeo da execução (video.webm)](artifacts/projects-recertificacao-te-6e331-t-has-recertification-false-chromium/video.webm)

- 🎬 [Vídeo da execução (video-1.webm)](artifacts/projects-recertificacao-te-6e331-t-has-recertification-false-chromium/video-1.webm)

- 📦 **Trace** — [`trace.zip`](artifacts/projects-recertificacao-te-6e331-t-has-recertification-false-chromium/trace.zip)

  ```bash
  npx playwright show-trace outputs/recertificacao/reports/all-suites_20260528-164619/artifacts/projects-recertificacao-te-6e331-t-has-recertification-false-chromium/trace.zip
  ```

- 🎥 **Vídeo** — [`video.webm`](artifacts/projects-recertificacao-te-6e331-t-has-recertification-false-chromium/video.webm)

- 🎥 **Vídeo** — [`video-1.webm`](artifacts/projects-recertificacao-te-6e331-t-has-recertification-false-chromium/video-1.webm)

- 📄 **DOM no momento da falha** — [`error-context.md`](artifacts/projects-recertificacao-te-6e331-t-has-recertification-false-chromium/error-context.md)
...
> _Bug-report estruturado:_ [`bug-reports/reinscricao-individual-pelo-admin__tc4-botao-reinscrever-fica-visivel-mas-desabilitado-quando-event-has-recertification-false.md`](bug-reports/reinscricao-individual-pelo-admin__tc4-botao-reinscrever-fica-visivel-mas-desabilitado-quando-event-has-recertification-false.md)
...
**Descrição do BUG:** [—] TC4 — Botão "Reinscrever" fica visível mas DESABILITADO quando event.has_recertification = false — TimeoutError: locator.innerText: Timeout 30000ms exceeded.
...
**Comportamento atual:** TimeoutError: locator.innerText: Timeout 30000ms exceeded.
...
| Outros | Browser: chromium |
| Outros | runId: all-suites_20260528-164619 |
| Outros | Duração até a falha: 31.93s |

**Evidências:**

- Screenshot capturado pelo Playwright (screenshot): artifacts/projects-recertificacao-te-6e331-t-has-recertification-false-chromium/test-failed-1.png
- Vídeo da execução (video-1.webm): artifacts/projects-recertificacao-te-6e331-t-has-recertification-false-chromium/video-1.webm
- Vídeo da execução (video.webm): artifacts/projects-recertificacao-te-6e331-t-has-recertification-false-chromium/video.webm
- Screenshot capturado pelo Playwright (screenshot): artifacts/projects-recertificacao-te-6e331-t-has-recertification-false-chromium/test-failed-2.png
- Snapshot do DOM/contexto da página (error-context.md): artifacts/projects-recertificacao-te-6e331-t-has-recertification-false-chromium/error-context.md
- Trace completo do Playwright (.zip) — `npx playwright show-trace`: artifacts/projects-recertificacao-te-6e331-t-has-recertification-false-chromium/trace.zip

<details><summary>📋 Ver texto agregado para copiar (Jira/GitHub/Linear)</summary>

```
Descrição do BUG
[—] TC4 — Botão "Reinscrever" fica visível mas DESABILITADO quando event.has_recertification = false — TimeoutError: locator.innerText: Timeout 30000ms exceeded.
...
- runId: all-suites_20260528-164619
- environment.json: staging-recertificacao
- testsuite: Reinscrição Individual pelo Admin
- testcase: TC4 — Botão "Reinscrever" fica visível mas DESABILITADO quando event.has_recertification = false
...
<a id="tc1-post-api-v2-attendees-com-recertification-true-responde-200-e-cria-attendee"></a>_Arquivo:_ `reinscricao-via-api-v2.spec.ts` · _Duração:_ 1.06s · _Browser:_ api
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-recertificacao-te-f253e-esponde-200-e-cria-attendee-api/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/recertificacao/reports/all-suites_20260528-164619/artifacts/projects-recertificacao-te-f253e-esponde-200-e-cria-attendee-api/trace.zip
  ```


---

### ❌ Falhou · TC2 — Recertificação de user não-aprovado retorna 422 com mensagem descritiva 

<a id="tc2-recertificacao-de-user-nao-aprovado-retorna-422-com-mensagem-descritiva"></a>_Arquivo:_ `reinscricao-via-api-v2.spec.ts` · _Duração:_ 0.77s · _Browser:_ api

> **❌ Por que falhou:** Quantidade fora do esperado: deveria ser maior a > 0, mas obteve 0. Isso geralmente indica que a ação que deveria popular a tela (listagem/filtro/busca) ficou vazia ou retornou menos itens que o necessário.
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-recertificacao-te-60f85-422-com-mensagem-descritiva-api/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/recertificacao/reports/all-suites_20260528-164619/artifacts/projects-recertificacao-te-60f85-422-com-mensagem-descritiva-api/trace.zip
  ```

- 📄 **DOM no momento da falha** — [`error-context.md`](artifacts/projects-recertificacao-te-60f85-422-com-mensagem-descritiva-api/error-context.md)

#### 🐛 Pronto para registro de bug

> ❓ **Análise automática:** Inconclusivo (precisa investigação manual) · Confiança 🔴 baixa
> _Por quê:_ Sem sinal Network in-scope ou padrão de erro conhecido — revisar trace
> _Bug-report estruturado:_ [`bug-reports/reinscricao-via-api-v2__tc2-recertificacao-de-user-nao-aprovado-retorna-422-com-mensagem-descritiva.md`](bug-reports/reinscricao-via-api-v2__tc2-recertificacao-de-user-nao-aprovado-retorna-422-com-mensagem-descritiva.md)

**Próximas ações sugeridas:**
- Sem evidência suficiente para classificar — abrir `trace.zip` (`npx playwright show-trace`) para ver passo a passo da execução.
- Reabrir o agente com o trace em mãos para reclassificar manualmente em uma das 4 categorias.

**Descrição do BUG:** [—] TC2 — Recertificação de user não-aprovado retorna 422 com mensagem descritiva — Quantidade fora do esperado: deveria ser maior a > 0, mas obteve 0. Isso geralmente indica que a ação que deveria popular a tela (listagem/filtro/busca) ficou vazia ou retornou menos itens que o necessário.
...
**Comportamento atual:** Quantidade fora do esperado: deveria ser maior a > 0, mas obteve 0. Isso geralmente indica que a ação que deveria popular a tela (listagem/filtro/busca) ficou vazia ou retornou menos itens que o necessário.
...
| Outros | Browser: api |
| Outros | runId: all-suites_20260528-164619 |
| Outros | Duração até a falha: 0.77s |

**Evidências:**

- Snapshot do DOM/contexto da página (error-context.md): artifacts/projects-recertificacao-te-60f85-422-com-mensagem-descritiva-api/error-context.md
- Trace completo do Playwright (.zip) — `npx playwright show-trace`: artifacts/projects-recertificacao-te-60f85-422-com-mensagem-descritiva-api/trace.zip

<details><summary>📋 Ver texto agregado para copiar (Jira/GitHub/Linear)</summary>

```
Descrição do BUG
[—] TC2 — Recertificação de user não-aprovado retorna 422 com mensagem descritiva — Quantidade fora do esperado: deveria ser maior a > 0, mas obteve 0. Isso geralmente indica que a ação que deveria popular a tela (listagem/filtro/busca) ficou vazia ou retornou menos itens que o necessário.
...
Comportamento atual
Quantidade fora do esperado: deveria ser maior a > 0, mas obteve 0. Isso geralmente indica que a ação que deveria popular a tela (listagem/filtro/busca) ficou vazia ou retornou menos itens que o necessário.
...
- runId: all-suites_20260528-164619
- environment.json: staging-recertificacao
- testsuite: Reinscrição via API V2
- testcase: TC2 — Recertificação de user não-aprovado retorna 422 com mensagem descritiva
...
<a id="tc3-payload-sem-recertification-segue-fluxo-legado-regressao"></a>_Arquivo:_ `reinscricao-via-api-v2.spec.ts` · _Duração:_ 0.50s · _Browser:_ api
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-recertificacao-te-07911-gue-fluxo-legado-regressão--api/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/recertificacao/reports/all-suites_20260528-164619/artifacts/projects-recertificacao-te-07911-gue-fluxo-legado-regressão--api/trace.zip
  ```
...
<a id="tc1-botao-reinscreva-se-aparece-no-banner-do-play-para-aluno-elegivel"></a>_Arquivo:_ `tc1-banner-reinscreva-se-aluno-elegivel.spec.ts` · _Duração:_ 1.55s · _Browser:_ chromium
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-recertificacao-te-7fd30-do-Play-para-aluno-elegível-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/recertificacao/reports/all-suites_20260528-164619/artifacts/projects-recertificacao-te-7fd30-do-Play-para-aluno-elegível-chromium/trace.zip
  ```
...
<a id="tc2-botao-reinscreva-se-nao-aparece-para-aluno-inelegivel-sem-disabled-visivel"></a>_Arquivo:_ `tc2-banner-nao-aparece-aluno-inelegivel.spec.ts` · _Duração:_ 1.60s · _Browser:_ chromium
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-recertificacao-te-79407-gível-sem-disabled-visível--chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/recertificacao/reports/all-suites_20260528-164619/artifacts/projects-recertificacao-te-79407-gível-sem-disabled-visível--chromium/trace.zip
  ```
...
<a id="tc3-click-em-reinscreva-se-dispara-subscribe-com-recertification-true-e-cria-novo-participant"></a>_Arquivo:_ `tc3-click-reinscreva-se-dispara-subscribe.spec.ts` · _Duração:_ 1.58s · _Browser:_ chromium
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-recertificacao-te-7fa9d-rue-e-cria-novo-participant-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/recertificacao/reports/all-suites_20260528-164619/artifacts/projects-recertificacao-te-7fa9d-rue-e-cria-novo-participant-chromium/trace.zip
  ```
...
<a id="tc5-post-em-link-publico-com-recertification-true-para-aluno-elegivel-cria-participant"></a>_Arquivo:_ `tc5-post-link-publico-aluno-elegivel-cria-participant.spec.ts` · _Duração:_ 1.32s · _Browser:_ chromium
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-recertificacao-te-6bff7-o-elegível-cria-participant-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/recertificacao/reports/all-suites_20260528-164619/artifacts/projects-recertificacao-te-6bff7-o-elegível-cria-participant-chromium/trace.zip
  ```
...
<a id="tc6-post-em-link-publico-com-recertification-true-para-aluno-inelegivel-retorna-erro-sem-criar-participant"></a>_Arquivo:_ `tc6-post-link-publico-aluno-inelegivel-erro.spec.ts` · _Duração:_ 1.11s · _Browser:_ chromium
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-recertificacao-te-7b9af--erro-sem-criar-participant-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/recertificacao/reports/all-suites_20260528-164619/artifacts/projects-recertificacao-te-7b9af--erro-sem-criar-participant-chromium/trace.zip
  ```
...
<a id="tc1-opcao-substituido-aparece-no-filtro-avancado-de-status-do-certificado-com-flag-on"></a>_Arquivo:_ `tc1-opcao-substituido-aparece-no-filtro-flag-on.spec.ts` · _Duração:_ 33.36s · _Browser:_ chromium
...
| # | Ação do passo | Resultado esperado | Status | Notas | Duração |
|---|---|---|:---:|---|---:|
| 1 | Acessar a lista de aprendizagem em "/learning_students" | Lista é exibida com colunas Nome, Status do certificado, etc. | ✅ | — | 9.57s |
| 2 | Clicar no ícone de filtro da coluna "Status do certificado" | Drawer de filtro avançado é exibido com lista de opções. | ✅ | — | 10.01s |
| 3 | Inspecionar as opções do filtro | Lista contém: Emitido, Pendente, Expirado, Aguardando assinatura, **Substituído**. | ✅ | — | 4.62s |
...
<a id="tc2-filtrar-por-substituido-exibe-apenas-alunos-com-certificate-status-4"></a>_Arquivo:_ `tc2-filtrar-por-substituido-exibe-status-4.spec.ts` · _Duração:_ 65.72s · _Browser:_ chromium
...
| # | Ação do passo | Resultado esperado | Status | Notas | Duração |
|---|---|---|:---:|---|---:|
| — | _Pré-condição:_ 1. Acessar a lista de aprendizagem em "/learning_students" → Lista exibe todos os alunos | — | ✅ | — | 12.18s |
| — | _Pré-condição:_ 2. Abrir o filtro avançado de "Status do certificado", marcar APENAS a opção "Substituído" e aplicar → Drawer fecha, listagem refilra | — | ✅ | — | 6.11s |
| — | _Pré-condição:_ 3. Inspecionar as linhas listadas → Apenas alunos com certificate_status = 4 aparecem; demais (VALID, EXPIRED, PENDING) ficam ocultos | — | ✅ | — | 30.24s |
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-recertificacao-te-f6b62-os-com-certificate-status-4-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/recertificacao/reports/all-suites_20260528-164619/artifacts/projects-recertificacao-te-f6b62-os-com-certificate-status-4-chromium/trace.zip
  ```
...
<a id="tc3-badge-substituido-e-exibido-na-coluna-de-status-para-participants-com-certificate-status-4"></a>_Arquivo:_ `tc3-badge-substituido-coluna-status.spec.ts` · _Duração:_ 33.55s · _Browser:_ chromium
...
| # | Ação do passo | Resultado esperado | Status | Notas | Duração |
|---|---|---|:---:|---|---:|
| — | _Pré-condição:_ 1. Acessar a lista de aprendizagem sem filtros aplicados → Lista é exibida | — | ✅ | — | 11.54s |
| — | _Pré-condição:_ 2. Localizar a linha de um aluno com certificado REPLACED (certificate_status = 4) → Coluna "Status do certificado" exibe badge com label "Substituído" | — | ✅ | — | 5.76s |
| — | _Pré-condição:_ 3. Posicionar o cursor sobre o badge → Tooltip explicativo é exibido | — | ✅ | — | 0.12s |
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-recertificacao-te-c99a9-ts-com-certificate-status-4-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/recertificacao/reports/all-suites_20260528-164619/artifacts/projects-recertificacao-te-c99a9-ts-com-certificate-status-4-chromium/trace.zip
  ```
...
<a id="tc4-opcao-substituido-nao-aparece-no-filtro-com-flag-off-regressao"></a>_Arquivo:_ `tc4-opcao-substituido-nao-aparece-flag-off-regressao.spec.ts` · _Duração:_ 26.12s · _Browser:_ chromium
...
| 2 | Acessar a lista de aprendizagem e abrir o filtro avançado de Status do certificado | Drawer de filtro é exibido. | ✅ | — | 13.92s |
| 3 | Inspecionar as opções | Lista contém apenas: Emitido, Pendente, Expirado, Aguardando assinatura. Opção "Substituído" NÃO está presente. | ✅ | — | 0.43s |
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-recertificacao-te-2dce4-tro-com-flag-OFF-regressão--chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/recertificacao/reports/all-suites_20260528-164619/artifacts/projects-recertificacao-te-2dce4-tro-com-flag-OFF-regressão--chromium/trace.zip
  ```
...
<a id="tc1-aluno-reinscrito-tem-progress-score-attendance-zerados-na-nova-inscricao"></a>_Arquivo:_ `tc1-progresso-score-attendance-zerados.spec.ts` · _Duração:_ 24.03s · _Browser:_ chromium
...
| # | Ação do passo | Resultado esperado | Status | Notas | Duração |
|---|---|---|:---:|---|---:|
| 1 | Reinscrever o aluno aprovado pelo fluxo da suíte 2 TC3 | Novo participant criado com `recertification_number = 1`. | ❌ | Quantidade fora do esperado: deveria ser menor a < 400, mas obteve 422. Isso geralmente indica que a ação que deveria popular a tela (listagem/filtro/busca) ficou vazia ou retornou menos itens que o necessário. | 14.26s |
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-recertificacao-te-490eb-e-zerados-na-nova-inscrição-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/recertificacao/reports/all-suites_20260528-164619/artifacts/projects-recertificacao-te-490eb-e-zerados-na-nova-inscrição-chromium/trace.zip
  ```
...
| Outros | Browser: chromium |
| Outros | runId: all-suites_20260528-164619 |
| Outros | Duração até a falha: 24.03s |
...
<a id="tc2-aluno-nao-reinscrito-recertification-number-0-mantem-progresso-historico-apos-deploy"></a>_Arquivo:_ `tc2-progresso-historico-mantido-recertification-zero.spec.ts` · _Duração:_ 1.19s · _Browser:_ chromium
...
- 📦 **Trace** — [`trace.zip`](artifacts/projects-recertificacao-te-53d5c-resso-histórico-após-deploy-chromium/trace.zip)
  ...
  ```bash
  npx playwright show-trace outputs/recertificacao/reports/all-suites_20260528-164619/artifacts/projects-recertificacao-te-53d5c-resso-histórico-após-deploy-chromium/trace.zip
  ```
