...
**Projeto:** Recertificação · **Ambiente:** `staging-recertificacao` · **Browsers:** chromium · **Gerado em:** 27/05/2026, 08:51:40
...
|---|---:|---|---:|---:|---:|---|---:|
| **Reinscrição pelo Aluno (Play e Link Público)** | 7 | `[⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘]` 0/0/7 | 0% | 0 | 7 | — | 6.8s |
