...
**Projeto:** Recertificação · **Ambiente:** `staging-base-de-conhecimento` · **Browsers:** chromium · **Gerado em:** 26/05/2026, 10:04:24
...
|---|---:|---|---:|---:|---:|---|---:|
| **Isolamento de Progresso, Score e Attendance por Inscrição** | 4 | `[⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘⊘]` 0/0/4 | 0% | 0 | 4 | — | 2.3s |
