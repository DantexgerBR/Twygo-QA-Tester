...
- `https://registrosf2.stage.twygoead.com/o/37079/records`
  108/305 interativos visíveis (**35%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: knowledge_repositories-menu · link: users-menu · link: companies-menu
- `https://registrosf2.stage.twygoead.com/o/37079/records/44280780/edit?mode=admin-avaliar`
  49/118 interativos visíveis (**42%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: knowledge_repositories-menu · link: users-menu · link: companies-menu
- `https://registrosf2.stage.twygoead.com/o/37079/records/44280772/edit?mode=admin-avaliar`
  49/119 interativos visíveis (**41%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: knowledge_repositories-menu · link: users-menu · link: companies-menu
- `https://registrosf2.stage.twygoead.com/o/37079/records/44280793/edit?mode=admin-avaliar`
  49/119 interativos visíveis (**41%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: knowledge_repositories-menu · link: users-menu · link: companies-menu
- `https://registrosf2.stage.twygoead.com/o/37079/records/44280777/edit?mode=admin-avaliar`
  52/122 interativos visíveis (**43%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: knowledge_repositories-menu · link: users-menu · link: companies-menu
- `https://registrosf2.stage.twygoead.com/o/37079/records/44280790/edit?mode=admin-avaliar`
  49/119 interativos visíveis (**41%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: knowledge_repositories-menu · link: users-menu · link: companies-menu

<details><summary>📁 Fora do escopo "Registros de Aprendizagem" — 153 erro(s) · 88 aviso(s) · 8 info _(silenciado dos KPIs principais)_</summary>

#### ❌ Erros JavaScript no navegador (77 ocorrência(s) · 7 mensagem(ens) distinta(s))

- **Erro JavaScript no navegador** — _36 ocorrência(s) em 13 URL(s)_
  > Failed to load resource: net::ERR_BLOCKED_BY_CLIENT.Inspector
- **Erro JavaScript no navegador** — _24 ocorrência(s) em 1 URL(s)_
  > Failed to load resource: the server responded with a status of 400 ()
  `https://registrosf2.stage.twygoead.com/o/37079/records`
- **Erro JavaScript no navegador** — _6 ocorrência(s) em 6 URL(s)_
  > TypeError: Cannot read properties of undefined (reading 'colorScheme')     at K1 (https://cdn-stage.twygo.com/vite/assets/primary-color-BkZ3heee.min.js:17:16432)     at https://cdn-stage.twygo.com/vite/assets/primary-color-BkZ3heee.min.js:17:17288     at Eu (https://cdn-stage.twygo.com/vite/assets/entrypoints/application.ts-DeHeomMs.min.js:39:16979)     at ac (https://cdn-stage.twygo.com/vite/asse ... [truncado, 1078 chars total]
- **Erro de execução da página** — _6 ocorrência(s) em 6 URL(s)_
...
- **Erro JavaScript no navegador** — _1 ocorrência(s) em 1 URL(s)_
  ...
  `https://registrosf2.stage.twygoead.com/o/37079/records/44280792/edit?mode=admin-avaliar`

#### ⚠️ Respostas HTTP de falha (26 no total · 3 únicas)

| Status | Método | URL | Ocorrências |
|---:|---|---|---:|
| 400 | GET | `https://registrosf2.stage.twygoead.com/api/v1/o/37079/beta_test/get_active_beta_test_notification?feature_name=registros_avaliacao&with_notification_history=true` | 24 |
| 404 | PATCH | `https://registrosf2.stage.twygoead.com/api/v1/o/37079/records/44280796/approve` | 1 |
| 404 | PATCH | `https://registrosf2.stage.twygoead.com/api/v1/o/37079/records/44280780/approve` | 1 |

#### ❌ Acessibilidade — axe-core (146 no total · 13 regra(s) única(s))

- **`color-contrast`** _(serious)_ — 13 ocorrência(s) em 6 URL(s)
  ...
  ```
- **`landmark-unique`** _(moderate)_ — 13 ocorrência(s) em 6 URL(s)
  ...
  ```
- **`meta-viewport`** _(moderate)_ — 13 ocorrência(s) em 6 URL(s)
  ...
  ```
- **`aria-allowed-attr`** _(critical)_ — 12 ocorrência(s) em 5 URL(s)
  ...
  ```
- **`image-alt`** _(critical)_ — 12 ocorrência(s) em 5 URL(s)
  ...
  ```
- **`label`** _(critical)_ — 12 ocorrência(s) em 5 URL(s)
  ...
  ```
- **`landmark-one-main`** _(moderate)_ — 12 ocorrência(s) em 5 URL(s)
  ...
  ```
- **`list`** _(serious)_ — 12 ocorrência(s) em 5 URL(s)
  ...
  <ul class="menu-main">
  ```
- **`page-has-heading-one`** _(moderate)_ — 12 ocorrência(s) em 5 URL(s)
  ...
  <html lang="en" xml:lang="en" xmlns="http://www.w3.org/1999/xhtml" class="wf-materialicons-n4-inactive wf-materialsymbolsoutlined-n4-inactive wf-inactive" data-theme="light" style="color-scheme: light
  ```
- **`region`** _(moderate)_ — 12 ocorrência(s) em 5 URL(s)
  ...
  ```
- **`empty-table-header`** _(minor)_ — 8 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`role-img-alt`** _(serious)_ — 8 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`select-name`** _(critical)_ — 7 ocorrência(s) em 1 URL(s)
