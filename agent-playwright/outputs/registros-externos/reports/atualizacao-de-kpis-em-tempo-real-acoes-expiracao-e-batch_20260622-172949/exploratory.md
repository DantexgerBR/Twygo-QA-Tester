...
- `https://registrosf2.stage.twygoead.com/o/37079/records`
  114/323 interativos visíveis (**35%**) · amostra: link: dashboard-menu · link: new_contents-menu · link: shared_events-menu · link: records-menu · link: certificates-menu · link: knowledge_repositories-menu · link: users-menu · link: companies-menu
- `about:blank`
  0/0 interativos visíveis (**0%**) · amostra: _(vazio)_

<details><summary>📁 Fora do escopo "Registros de Aprendizagem" — 340 erro(s) · 181 aviso(s) · 19 info _(silenciado dos KPIs principais)_</summary>

#### ❌ Erros JavaScript no navegador (183 ocorrência(s) · 7 mensagem(ens) distinta(s))

- **Erro JavaScript no navegador** — _74 ocorrência(s) em 26 URL(s)_
  > Failed to load resource: net::ERR_BLOCKED_BY_CLIENT.Inspector
- **Erro JavaScript no navegador** — _52 ocorrência(s) em 1 URL(s)_
  > Failed to load resource: the server responded with a status of 400 ()
  `https://registrosf2.stage.twygoead.com/o/37079/records`
- **Erro JavaScript no navegador** — _21 ocorrência(s) em 21 URL(s)_
  > TypeError: Cannot read properties of undefined (reading 'colorScheme')     at K1 (https://cdn-stage.twygo.com/vite/assets/primary-color-B6MTyZXg.min.js:17:16432)     at https://cdn-stage.twygo.com/vite/assets/primary-color-B6MTyZXg.min.js:17:17288     at Eu (https://cdn-stage.twygo.com/vite/assets/entrypoints/application.ts-DsDLDWFw.min.js:39:16979)     at ac (https://cdn-stage.twygo.com/vite/asse ... [truncado, 1078 chars total]
- **Erro de execução da página** — _21 ocorrência(s) em 21 URL(s)_
...
- **Erro JavaScript no navegador** — _6 ocorrência(s) em 1 URL(s)_
  ...
  `https://registrosf2.stage.twygoead.com/o/37079/records`
- **Erro JavaScript no navegador** — _5 ocorrência(s) em 1 URL(s)_
...
#### ⚠️ Respostas HTTP de falha (58 no total · 2 únicas)

| Status | Método | URL | Ocorrências |
|---:|---|---|---:|
| 400 | GET | `https://registrosf2.stage.twygoead.com/api/v1/o/37079/beta_test/get_active_beta_test_notification?feature_name=registros_avaliacao&with_notification_history=true` | 52 |
| 401 | GET | `https://registrosf2.stage.twygoead.com/api/v1/o/37079/professionals/verify_facelift_feature_flag` | 6 |

#### ❌ Acessibilidade — axe-core (299 no total · 15 regra(s) única(s))

- **`landmark-one-main`** _(moderate)_ — 29 ocorrência(s) em 2 URL(s)
  ...
  ```
- **`page-has-heading-one`** _(moderate)_ — 29 ocorrência(s) em 2 URL(s)
  ...
  <html lang="en" xml:lang="en" xmlns="http://www.w3.org/1999/xhtml" class="wf-materialicons-n4-inactive wf-materialsymbolsoutlined-n4-inactive wf-inactive" data-theme="light" style="color-scheme: light
  ```
- **`color-contrast`** _(serious)_ — 23 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`landmark-unique`** _(moderate)_ — 23 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`meta-viewport`** _(moderate)_ — 23 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`select-name`** _(critical)_ — 20 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`aria-allowed-attr`** _(critical)_ — 19 ocorrência(s) em 1 URL(s)
...
- **`empty-table-header`** _(minor)_ — 19 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`image-alt`** _(critical)_ — 19 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`label`** _(critical)_ — 19 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`list`** _(serious)_ — 19 ocorrência(s) em 1 URL(s)
  ...
  <ul class="menu-main">
  ```
- **`region`** _(moderate)_ — 19 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`role-img-alt`** _(serious)_ — 18 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`document-title`** _(serious)_ — 10 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`html-has-lang`** _(serious)_ — 10 ocorrência(s) em 1 URL(s)
