...
- `https://registrosf2.stage.twygoead.com/o/37079/records?in_use_mode_layout=true`
  36/106 interativos visíveis (**34%**) · amostra: link: custom_url-menu · link: dashboard-menu · link: my_contents-menu · link: communities-menu · link: my_history-menu · link: Registros F2 · button: Twygo Academy · link

<details><summary>📁 Fora do escopo "Registros de Aprendizagem" — 238 erro(s) · 152 aviso(s) · 24 info _(silenciado dos KPIs principais)_</summary>

#### ❌ Erros JavaScript no navegador (52 ocorrência(s) · 4 mensagem(ens) distinta(s))

- **Erro JavaScript no navegador** — _25 ocorrência(s) em 1 URL(s)_
...
#### ❌ Respostas HTTP de falha (26 no total · 3 únicas)

| Status | Método | URL | Ocorrências |
|---:|---|---|---:|
| 400 | GET | `https://registrosf2.stage.twygoead.com/api/v1/o/37079/beta_test/get_active_beta_test_notification?feature_name=treinamentos&with_notification_history=true` | 16 |
| 400 | GET | `https://registrosf2.stage.twygoead.com/api/v1/o/37079/beta_test/get_active_beta_test_notification?feature_name=registros_avaliacao&with_notification_history=true` | 9 |
| 503 | GET | `https://registrosf2.stage.twygoead.com/o/37079/records?in_use_mode_layout=true` | 1 |

#### ❌ Acessibilidade — axe-core (336 no total · 16 regra(s) única(s))

- **`landmark-one-main`** _(moderate)_ — 26 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`region`** _(moderate)_ — 26 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`aria-allowed-attr`** _(critical)_ — 25 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`color-contrast`** _(serious)_ — 25 ocorrência(s) em 1 URL(s)
  ...
  ```html
  <a class="back-dashboard" href="/o/37079/use_mode_itens/368938/embed?menu_id=boas-vindas">
  Registros F2
  </a>
  ```
- **`image-alt`** _(critical)_ — 25 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`landmark-unique`** _(moderate)_ — 25 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`list`** _(serious)_ — 25 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`meta-viewport`** _(moderate)_ — 25 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`page-has-heading-one`** _(moderate)_ — 25 ocorrência(s) em 1 URL(s)
  ...
  <html lang="en" xml:lang="en" xmlns="http://www.w3.org/1999/xhtml" class="wf-materialicons-n4-inactive wf-materialsymbolsoutlined-n4-inactive wf-inactive" data-theme="light" style="color-scheme: light
  ```
- **`role-img-alt`** _(serious)_ — 25 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`empty-table-header`** _(minor)_ — 24 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`label`** _(critical)_ — 24 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`aria-progressbar-name`** _(serious)_ — 14 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`select-name`** _(critical)_ — 14 ocorrência(s) em 1 URL(s)
  ...
  ```
- **`button-name`** _(critical)_ — 7 ocorrência(s) em 1 URL(s)
