...
// TC10 — Adicionar widget 'Meus certificados'.

import { test, expect } from '../../../../../src/fixtures/exploratory-fixture.js';
import * as allure from 'allure-js-commons';
import { PainelFormPage } from '../../../pages/PainelFormPage.js';
import { cleanupPanel } from '../../../utils/test-cleanup.js';
import { widgetCertificadosData as data } from './adicionar-widget-meus-certificados.data.js';
...
test.describe('Adicionar widgets', () => {
  ...
  test("Adicionar widget 'Meus certificados'", async ({ page }) => {
    await allure.epic('Twygo - Widgets');
    await allure.feature('Adicionar widgets');
    await allure.story("Adicionar widget 'Meus certificados'");
