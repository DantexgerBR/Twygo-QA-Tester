/**
 * Dados compartilhados pela suíte "Importar abas".
 *
 ...
 * do `widgets-grid-*` / `tabs-navigation-add-button`. Passar uma Descrição na
 * criação evita o estado bugado.
 *
 * Remover este workaround quando 32872141 for corrigido em produção.
 */
export const importarAbasSharedData = {
  panelDescription:
    'Painel criado pela automação de testes (suíte Importar abas).',
} as const;
