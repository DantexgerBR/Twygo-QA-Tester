# Reconnaissance — Criar view para acompanhamento de consumo de créditos (view interna)

> Snapshot do DOM da área desta testsuite, capturado em 2026-05-04T12:59:38.323Z.
> Planners DEVEM consumir este arquivo + a prosa do XML, e PULAR exploração ao vivo.

## Testcases desta testsuite (do XML)

1. **Validar as 4 views e suas respectivas colunas** (importance: crítico, 6 steps)
